...
pub struct OrderSignedResponseRequestPayloadResponseData {
    /// Status information of the order.
    #[serde(rename = "statuses", skip_serializing_if = "Option::is_none")]
    pub statuses: Option<Vec<models::OrderSignedResponseRequestPayloadResponseDataStatusesInner>>,
}

impl OrderSignedResponseRequestPayloadResponseData {
    pub fn new() -> OrderSignedResponseRequestPayloadResponseData {
