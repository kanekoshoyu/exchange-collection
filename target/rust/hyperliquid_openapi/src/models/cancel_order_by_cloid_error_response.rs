...
/// CancelOrderByCloidErrorResponse : Response when there is an error in canceling the order(s) by cloid.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CancelOrderByCloidErrorResponse {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
    #[serde(rename = "response", skip_serializing_if = "Option::is_none")]
    pub response: Option<Box<models::PlaceOrderErrorResponseResponse>>,
}

impl CancelOrderByCloidErrorResponse {
    /// Response when there is an error in canceling the order(s) by cloid.
    pub fn new() -> CancelOrderByCloidErrorResponse {
