...
pub struct OrderSignedRequestRequestPayloadActionOrdersInner {
    /// Order attribute 'a'.
    ...
    pub t: Option<Box<models::OrderSignedRequestRequestPayloadActionOrdersInnerT>>,
}

impl OrderSignedRequestRequestPayloadActionOrdersInner {
    pub fn new() -> OrderSignedRequestRequestPayloadActionOrdersInner {
