...
pub struct WebSocketMessage {
    /// The method being invoked (e.g., \"subscribe\").
    #[serde(rename = "method")]
    pub method: String,
    #[serde(rename = "subscription")]
    pub subscription: Box<models::WebSocketMessageSubscription>,
}

impl WebSocketMessage {
    pub fn new(method: String, subscription: models::WebSocketMessageSubscription) -> WebSocketMessage {
        WebSocketMessage {
            method,
