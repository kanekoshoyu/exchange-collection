...
/// InitiateWithdrawalRequest : ### Request Schema The request body for initiating a withdrawal flow. This request will trigger the L1 validators to sign and send the withdrawal request to the bridge contract. 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct InitiateWithdrawalRequest {
    #[serde(rename = "action")]
    pub action: Box<models::InitiateWithdrawalRequestAction>,
...
impl InitiateWithdrawalRequest {
    /// ### Request Schema The request body for initiating a withdrawal flow. This request will trigger the L1 validators to sign and send the withdrawal request to the bridge contract. 
    pub fn new(action: models::InitiateWithdrawalRequestAction, nonce: i32, signature: serde_json::Value) -> InitiateWithdrawalRequest {
