...
/// VaultTransferRequest : ### Request Schema The request body for depositing into or withdrawing from a vault. The `isDeposit` flag indicates whether the operation is a deposit or a withdrawal. 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct VaultTransferRequest {
    #[serde(rename = "action")]
    pub action: Box<models::VaultTransferRequestAction>,
...
impl VaultTransferRequest {
    ...
    pub fn new(action: models::VaultTransferRequestAction, nonce: f64, signature: serde_json::Value) -> VaultTransferRequest {
