...
/// BatchModifyOrderResponse : ### Response Schema The response body indicating the status of the batch modify order request. 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct BatchModifyOrderResponse {
    /// Status of the batch modify request.
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
    #[serde(rename = "response", skip_serializing_if = "Option::is_none")]
    pub response: Option<Box<models::BatchModifyOrderResponseResponse>>,
}

impl BatchModifyOrderResponse {
    /// ### Response Schema The response body indicating the status of the batch modify order request. 
    pub fn new() -> BatchModifyOrderResponse {
