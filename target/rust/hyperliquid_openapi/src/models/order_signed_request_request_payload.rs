...
pub struct OrderSignedRequestRequestPayload {
    #[serde(rename = "action", skip_serializing_if = "Option::is_none")]
    pub action: Option<Box<models::OrderSignedRequestRequestPayloadAction>>,
    /// Nonce value for the request.
    #[serde(rename = "nonce", skip_serializing_if = "Option::is_none")]
    pub nonce: Option<i32>,
    #[serde(rename = "signature", skip_serializing_if = "Option::is_none")]
    pub signature: Option<Box<models::OrderSignedRequestRequestPayloadSignature>>,
    /// The vault address in hexadecimal format.
    #[serde(rename = "vaultAddress", skip_serializing_if = "Option::is_none")]
    pub vault_address: Option<String>,
}

impl OrderSignedRequestRequestPayload {
    pub fn new() -> OrderSignedRequestRequestPayload {
