...
/// L1SpotTransferResponse : ### Successful Response Schema The response body indicating the status of the L1 spot transfer request. 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct L1SpotTransferResponse {
    /// Status of the L1 spot transfer request.
