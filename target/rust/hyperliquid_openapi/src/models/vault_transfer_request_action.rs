...
pub struct VaultTransferRequestAction {
    /// Must be \"vaultTransfer\".
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<String>,
    /// Address of the vault in 42-character hexadecimal format.
    #[serde(rename = "vaultAddress")]
    pub vault_address: String,
    /// If true, the request is for depositing funds into the vault. If false, the request is for withdrawing funds from the vault.
    #[serde(rename = "isDeposit")]
    pub is_deposit: bool,
    /// Amount of USD to deposit or withdraw.
    #[serde(rename = "usd")]
    pub usd: f64,
}

impl VaultTransferRequestAction {
    pub fn new(vault_address: String, is_deposit: bool, usd: f64) -> VaultTransferRequestAction {
