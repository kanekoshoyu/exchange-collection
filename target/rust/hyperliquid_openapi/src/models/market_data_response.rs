...
pub struct MarketDataResponse {
    /// APE market data value.
    #[serde(rename = "APE", skip_serializing_if = "Option::is_none")]
    pub ape: Option<String>,
    /// ARB market data value.
    #[serde(rename = "ARB", skip_serializing_if = "Option::is_none")]
    pub arb: Option<String>,
}

impl MarketDataResponse {
    pub fn new() -> MarketDataResponse {
        MarketDataResponse {
            ape: None,
            arb: None,
        }
