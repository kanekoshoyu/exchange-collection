...
pub struct WebSocketSubscriptionResponse {
    /// The channel to which the response corresponds.
    #[serde(rename = "channel", skip_serializing_if = "Option::is_none")]
    pub channel: Option<String>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::WebSocketSubscriptionResponseData>>,
}

impl WebSocketSubscriptionResponse {
    pub fn new() -> WebSocketSubscriptionResponse {
