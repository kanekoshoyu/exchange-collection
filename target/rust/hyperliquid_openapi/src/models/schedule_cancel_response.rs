...
/// ScheduleCancelResponse : ### Response Schema The response body indicating the status of the schedule cancel request. 
...
pub struct ScheduleCancelResponse {
    ...
    pub response: Option<Box<models::ScheduleCancelResponseResponse>>,
}

impl ScheduleCancelResponse {
    /// ### Response Schema The response body indicating the status of the schedule cancel request. 
    pub fn new() -> ScheduleCancelResponse {
