...
/// SpotToPerpTransferResponse : ### Successful Response Schema The response body indicating the status of the transfer request. 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SpotToPerpTransferResponse {
