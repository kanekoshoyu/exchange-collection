...
/// UpdateIsolatedMarginResponse : ### Successful Response Schema The response body indicating the status of the update isolated margin request. 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateIsolatedMarginResponse {
    /// Status of the update isolated margin request.
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
    #[serde(rename = "response", skip_serializing_if = "Option::is_none")]
    pub response: Option<Box<models::UpdateLeverageResponseResponse>>,
}

impl UpdateIsolatedMarginResponse {
    /// ### Successful Response Schema The response body indicating the status of the update isolated margin request. 
    pub fn new() -> UpdateIsolatedMarginResponse {
