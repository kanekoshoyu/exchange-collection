...
/// CancelOrderByCloidRequest : ### Request Schema The request body for canceling orders by Client Order ID (cloid). You can specify one or more orders to cancel using their cloID and the associated asset. 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CancelOrderByCloidRequest {
    #[serde(rename = "action")]
    pub action: Box<models::CancelOrderByCloidRequestAction>,
    ...
    /// Onchain address in 42-character hexadecimal format, required if trading on behalf of a vault. Example: 0x0000000000000000000000000000000000000000. 
    #[serde(rename = "vaultAddress", skip_serializing_if = "Option::is_none")]
    pub vault_address: Option<String>,
}

impl CancelOrderByCloidRequest {
    ...
    pub fn new(action: models::CancelOrderByCloidRequestAction, nonce: f64, signature: serde_json::Value) -> CancelOrderByCloidRequest {
