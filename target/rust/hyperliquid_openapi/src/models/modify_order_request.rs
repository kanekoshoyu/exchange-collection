...
/// ModifyOrderRequest : ### Request Schema The request body for modifying an existing order. 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ModifyOrderRequest {
    #[serde(rename = "action")]
    pub action: Box<models::ModifyOrderRequestAction>,
...
impl ModifyOrderRequest {
    ...
    pub fn new(action: models::ModifyOrderRequestAction, nonce: i32, signature: models::ModifyOrderRequestSignature) -> ModifyOrderRequest {
        ModifyOrderRequest {
