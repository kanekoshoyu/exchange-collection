...
pub struct PlaceOrderRequestActionOrdersInner {
    /// The asset.
    #[serde(rename = "a", skip_serializing_if = "Option::is_none")]
    pub a: Option<f64>,
    /// Indicates if the order is a buy order.
    ...
    pub t: Option<Box<models::PlaceOrderRequestActionOrdersInnerT>>,
    /// Optional client order ID (cloid), a 128-bit hex string. Example: 0x1234567890abcdef1234567890abcdef. 
    #[serde(rename = "c", skip_serializing_if = "Option::is_none")]
    pub c: Option<String>,
}

impl PlaceOrderRequestActionOrdersInner {
    pub fn new() -> PlaceOrderRequestActionOrdersInner {
