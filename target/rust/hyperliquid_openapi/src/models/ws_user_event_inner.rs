...
#[serde(untagged)]
pub enum WsUserEventInner {
    WsUserFill(Box<models::WsUserFill>),
    WsUserFunding(Box<models::WsUserFunding>),
    WsLiquidation(Box<models::WsLiquidation>),
    WsNonUserCancel(Box<models::WsNonUserCancel>),
}

impl Default for WsUserEventInner {
    fn default() -> Self {
        Self::WsUserFill(Default::default())
    }
}
