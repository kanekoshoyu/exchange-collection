...
pub struct UpdateLeverageErrorResponseResponseData {
    /// Description of the error encountered during the update leverage request.
    #[serde(rename = "error", skip_serializing_if = "Option::is_none")]
    pub error: Option<String>,
}

impl UpdateLeverageErrorResponseResponseData {
    pub fn new() -> UpdateLeverageErrorResponseResponseData {
