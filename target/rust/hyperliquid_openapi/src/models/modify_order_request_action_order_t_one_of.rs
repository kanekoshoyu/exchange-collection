...
/// ModifyOrderRequestActionOrderTOneOf : Limit order type with time-in-force options.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ModifyOrderRequestActionOrderTOneOf {
    #[serde(rename = "limit", skip_serializing_if = "Option::is_none")]
    pub limit: Option<Box<models::ModifyOrderRequestActionOrderTOneOfLimit>>,
}

impl ModifyOrderRequestActionOrderTOneOf {
    /// Limit order type with time-in-force options.
    pub fn new() -> ModifyOrderRequestActionOrderTOneOf {
        ModifyOrderRequestActionOrderTOneOf {
            limit: None,
        }
    }
}
