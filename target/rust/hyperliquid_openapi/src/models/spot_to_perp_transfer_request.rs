...
/// SpotToPerpTransferRequest : ### Request Schema The request body for transferring USDC between the spot wallet and the perpetual wallet. The transfer can be from spot to perp or vice versa. 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SpotToPerpTransferRequest {
    #[serde(rename = "action")]
    pub action: Box<models::SpotToPerpTransferRequestAction>,
    /// Recommended to use the current timestamp in milliseconds, must match the nonce in the action object.
    #[serde(rename = "nonce")]
    pub nonce: i32,
...
impl SpotToPerpTransferRequest {
    ...
    pub fn new(action: models::SpotToPerpTransferRequestAction, nonce: i32, signature: serde_json::Value) -> SpotToPerpTransferRequest {
