...
pub struct WebSocketPostResponseData {
    /// Unique identifier for the response.
    #[serde(rename = "id", skip_serializing_if = "Option::is_none")]
    pub id: Option<i32>,
    #[serde(rename = "response", skip_serializing_if = "Option::is_none")]
    pub response: Option<Box<models::WebSocketPostResponseDataResponse>>,
}

impl WebSocketPostResponseData {
    pub fn new() -> WebSocketPostResponseData {
