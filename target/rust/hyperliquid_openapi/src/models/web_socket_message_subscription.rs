...
pub struct WebSocketMessageSubscription {
    /// The type of data subscription (e.g., \"trades\", \"orderBook\").
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<String>,
    /// The cryptocurrency for which data is being subscribed (e.g., \"SOL\").
    #[serde(rename = "coin", skip_serializing_if = "Option::is_none")]
    pub coin: Option<String>,
}

impl WebSocketMessageSubscription {
    pub fn new() -> WebSocketMessageSubscription {
