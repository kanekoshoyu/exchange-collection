...
pub struct UpdateLeverageResponseResponse {
    /// Indicates the response type for a successful operation.
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<String>,
}

impl UpdateLeverageResponseResponse {
    pub fn new() -> UpdateLeverageResponseResponse {
