...
pub struct OrderSignedRequestRequestPayloadAction {
    /// The type of action to perform.
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<String>,
    /// List of orders to execute.
    #[serde(rename = "orders", skip_serializing_if = "Option::is_none")]
    pub orders: Option<Vec<models::OrderSignedRequestRequestPayloadActionOrdersInner>>,
    /// Grouping type for the order.
    #[serde(rename = "grouping", skip_serializing_if = "Option::is_none")]
    pub grouping: Option<String>,
}

impl OrderSignedRequestRequestPayloadAction {
    pub fn new() -> OrderSignedRequestRequestPayloadAction {
