...
pub struct BatchModifyOrderErrorResponseResponseData {
    /// Description of the error encountered during the batch modify order request.
    #[serde(rename = "error", skip_serializing_if = "Option::is_none")]
    pub error: Option<String>,
}

impl BatchModifyOrderErrorResponseResponseData {
    pub fn new() -> BatchModifyOrderErrorResponseResponseData {
