...
/// L2BookRequest : L2 Book snapshot
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct L2BookRequest {
    /// Request type to retrieve the level 2 order book.
    #[serde(rename = "type")]
    pub r#type: String,
    /// The cryptocurrency coin for which to retrieve the order book.
    #[serde(rename = "coin")]
    pub coin: String,
}
...
impl L2BookRequest {
    /// L2 Book snapshot
    pub fn new(r#type: String, coin: String) -> L2BookRequest {
        L2BookRequest {
            r#type,
            coin,
        }
