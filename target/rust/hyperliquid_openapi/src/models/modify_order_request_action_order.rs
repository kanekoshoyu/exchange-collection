...
pub struct ModifyOrderRequestActionOrder {
    /// Asset identifier.
    ...
    pub t: Option<Box<models::ModifyOrderRequestActionOrderT>>,
...
impl ModifyOrderRequestActionOrder {
    pub fn new() -> ModifyOrderRequestActionOrder {
