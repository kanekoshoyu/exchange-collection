...
pub struct Error {
    #[serde(rename = "error_source", skip_serializing_if = "Option::is_none")]
    pub error_source: Option<String>,
    #[serde(rename = "error_type", skip_serializing_if = "Option::is_none")]
    pub error_type: Option<ErrorType>,
    #[serde(rename = "error_string", skip_serializing_if = "Option::is_none")]
...
pub enum ErrorType {
    #[serde(rename = "Tick")]
    Tick,
    #[serde(rename = "MinTradeNtl")]
    MinTradeNtl,
    #[serde(rename = "Margin")]
    Margin,
    #[serde(rename = "ReduceOnly")]
    ReduceOnly,
    #[serde(rename = "BadAloPx")]
    BadAloPx,
    #[serde(rename = "IocCancel")]
    IocCancel,
    #[serde(rename = "BadTriggerPx")]
    BadTriggerPx,
    #[serde(rename = "MarketOrderNoLiquidity")]
    MarketOrderNoLiquidity,
    #[serde(rename = "MissingOrder")]
    MissingOrder,
}
