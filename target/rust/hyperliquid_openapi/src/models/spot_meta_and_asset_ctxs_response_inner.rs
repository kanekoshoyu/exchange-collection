...
#[serde(untagged)]
pub enum SpotMetaAndAssetCtxsResponseInner {
    SpotMetaAndAssetCtxsResponseInnerOneOf(Box<models::SpotMetaAndAssetCtxsResponseInnerOneOf>),
    Array(Vec<models::SpotMetaAndAssetCtxsResponseInnerOneOf1Inner>),
}

impl Default for SpotMetaAndAssetCtxsResponseInner {
    fn default() -> Self {
        Self::SpotMetaAndAssetCtxsResponseInnerOneOf(Default::default())
    }
}
