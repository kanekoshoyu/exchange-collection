...
pub struct PlaceOrderFilledResponseResponseDataStatusesInnerFilled {
    /// The order ID.
    #[serde(rename = "oid", skip_serializing_if = "Option::is_none")]
    pub oid: Option<i32>,
    #[serde(rename = "totalSz", skip_serializing_if = "Option::is_none")]
    pub total_sz: Option<i32>,
    #[serde(rename = "avgPx", skip_serializing_if = "Option::is_none")]
    pub avg_px: Option<i32>,
}

impl PlaceOrderFilledResponseResponseDataStatusesInnerFilled {
    pub fn new() -> PlaceOrderFilledResponseResponseDataStatusesInnerFilled {
