...
/// MetaAndAssetCtxsResponse : Metadata and asset context information.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct MetaAndAssetCtxsResponse {
    /// Metadata about available assets or universes.
    #[serde(rename = "universe")]
    pub universe: Vec<models::MetaResponseUniverseInner>,
    /// Asset context information.
    #[serde(rename = "assetContexts")]
    pub asset_contexts: Vec<models::MetaAndAssetCtxsResponseAssetContextsInner>,
}

impl MetaAndAssetCtxsResponse {
    /// Metadata and asset context information.
    pub fn new(universe: Vec<models::MetaResponseUniverseInner>, asset_contexts: Vec<models::MetaAndAssetCtxsResponseAssetContextsInner>) -> MetaAndAssetCtxsResponse {
