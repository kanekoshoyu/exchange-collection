...
pub struct OrderSignedResponseRequestPayload {
    /// Status of the request.
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
    #[serde(rename = "response", skip_serializing_if = "Option::is_none")]
    pub response: Option<Box<models::OrderSignedResponseRequestPayloadResponse>>,
}

impl OrderSignedResponseRequestPayload {
    pub fn new() -> OrderSignedResponseRequestPayload {
