...
pub struct WebSocketResponse {
    /// The channel of the response (e.g., \"subscriptionResponse\").
    #[serde(rename = "channel")]
    pub channel: String,
    #[serde(rename = "data")]
    pub data: Box<models::WebSocketResponseData>,
}

impl WebSocketResponse {
    pub fn new(channel: String, data: models::WebSocketResponseData) -> WebSocketResponse {
        WebSocketResponse {
            channel,
            data: Box::new(data),
        }
