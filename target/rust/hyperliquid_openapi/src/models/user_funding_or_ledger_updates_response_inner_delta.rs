...
/// UserFundingOrLedgerUpdatesResponseInnerDelta : Details of the change in the user's balance.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UserFundingOrLedgerUpdatesResponseInnerDelta {
    /// The cryptocurrency or asset symbol.
    #[serde(rename = "coin", skip_serializing_if = "Option::is_none")]
    pub coin: Option<String>,
    /// The rate of funding applicable.
    #[serde(rename = "fundingRate", skip_serializing_if = "Option::is_none")]
    pub funding_rate: Option<String>,
    /// The size of the position affected.
    #[serde(rename = "szi", skip_serializing_if = "Option::is_none")]
    pub szi: Option<String>,
    /// The type of ledger update, e.g., funding or non-funding.
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<String>,
    /// The change in USDC balance.
    #[serde(rename = "usdc", skip_serializing_if = "Option::is_none")]
    pub usdc: Option<String>,
}

impl UserFundingOrLedgerUpdatesResponseInnerDelta {
    /// Details of the change in the user's balance.
    pub fn new() -> UserFundingOrLedgerUpdatesResponseInnerDelta {
        UserFundingOrLedgerUpdatesResponseInnerDelta {
            coin: None,
            funding_rate: None,
            szi: None,
            r#type: None,
