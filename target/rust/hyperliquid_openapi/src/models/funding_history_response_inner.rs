...
pub struct FundingHistoryResponseInner {
    /// The cryptocurrency or asset symbol.
    #[serde(rename = "coin", skip_serializing_if = "Option::is_none")]
    pub coin: Option<String>,
    /// The rate of funding applicable at the time.
    #[serde(rename = "fundingRate", skip_serializing_if = "Option::is_none")]
    pub funding_rate: Option<String>,
    /// The premium associated with the funding.
    #[serde(rename = "premium", skip_serializing_if = "Option::is_none")]
    pub premium: Option<String>,
    /// The timestamp of the funding rate update.
    #[serde(rename = "time", skip_serializing_if = "Option::is_none")]
    pub time: Option<i32>,
}

impl FundingHistoryResponseInner {
    pub fn new() -> FundingHistoryResponseInner {
