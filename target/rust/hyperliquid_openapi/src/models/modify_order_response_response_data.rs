...
pub struct ModifyOrderResponseResponseData {
    /// Status of the order modification (e.g., \"modified\" or \"failed\").
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
}

impl ModifyOrderResponseResponseData {
    pub fn new() -> ModifyOrderResponseResponseData {
