...
pub struct SpotToPerpTransferRequestActionClassTransfer {
    /// The amount of raw USDC to send, represented as an integer (e.g., for 1 USDC, use 1e6).
    #[serde(rename = "usdc", skip_serializing_if = "Option::is_none")]
    pub usdc: Option<i32>,
    /// If true, transfer from spot to perp wallet; if false, transfer from perp to spot wallet.
    #[serde(rename = "toPerp", skip_serializing_if = "Option::is_none")]
    pub to_perp: Option<bool>,
}

impl SpotToPerpTransferRequestActionClassTransfer {
    pub fn new() -> SpotToPerpTransferRequestActionClassTransfer {
