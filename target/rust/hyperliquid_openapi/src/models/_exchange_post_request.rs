...
#[serde(untagged)]
pub enum ExchangePostRequest {
    PlaceOrderRequest(Box<models::PlaceOrderRequest>),
    CancelOrderRequest(Box<models::CancelOrderRequest>),
    CancelOrderByCloidRequest(Box<models::CancelOrderByCloidRequest>),
    ScheduleCancelRequest(Box<models::ScheduleCancelRequest>),
    ModifyOrderRequest(Box<models::ModifyOrderRequest>),
    BatchModifyOrderRequest(Box<models::BatchModifyOrderRequest>),
    UpdateLeverageRequest(Box<models::UpdateLeverageRequest>),
    UpdateIsolatedMarginRequest(Box<models::UpdateIsolatedMarginRequest>),
    L1SpotTransferRequest(Box<models::L1SpotTransferRequest>),
    InitiateWithdrawalRequest(Box<models::InitiateWithdrawalRequest>),
    SpotToPerpTransferRequest(Box<models::SpotToPerpTransferRequest>),
    VaultTransferRequest(Box<models::VaultTransferRequest>),
}

impl Default for ExchangePostRequest {
    fn default() -> Self {
        Self::PlaceOrderRequest(Default::default())
    }
}
