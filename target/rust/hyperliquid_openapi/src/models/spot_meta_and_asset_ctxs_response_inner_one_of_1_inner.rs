...
pub struct SpotMetaAndAssetCtxsResponseInnerOneOf1Inner {
...
impl SpotMetaAndAssetCtxsResponseInnerOneOf1Inner {
    pub fn new() -> SpotMetaAndAssetCtxsResponseInnerOneOf1Inner {
