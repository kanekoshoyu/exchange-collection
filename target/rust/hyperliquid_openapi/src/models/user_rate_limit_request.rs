...
pub struct UserRateLimitRequest {
    /// Address in 42-character hexadecimal format.
    #[serde(rename = "user")]
    pub user: String,
    /// Request type to check user rate limits.
    #[serde(rename = "type")]
    pub r#type: String,
}

impl UserRateLimitRequest {
    pub fn new(user: String, r#type: String) -> UserRateLimitRequest {
