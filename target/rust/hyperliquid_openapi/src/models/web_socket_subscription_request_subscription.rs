...
pub struct WebSocketSubscriptionRequestSubscription {
    /// The type of subscription.
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<Type>,
    /// Address of the user. Optional based on subscription type.
    ...
    /// Coin symbol. Optional based on subscription type.
    #[serde(rename = "coin", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub coin: Option<Option<String>>,
    /// Candle interval. Optional based on subscription type.
...
impl WebSocketSubscriptionRequestSubscription {
    pub fn new() -> WebSocketSubscriptionRequestSubscription {
