...
pub struct L1SpotTransferErrorResponseResponse {
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<String>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::L1SpotTransferErrorResponseResponseData>>,
}

impl L1SpotTransferErrorResponseResponse {
    pub fn new() -> L1SpotTransferErrorResponseResponse {
