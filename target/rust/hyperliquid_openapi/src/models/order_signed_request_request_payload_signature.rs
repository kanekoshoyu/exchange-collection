...
pub struct OrderSignedRequestRequestPayloadSignature {
    /// Signature part 'r'.
...
impl OrderSignedRequestRequestPayloadSignature {
    pub fn new() -> OrderSignedRequestRequestPayloadSignature {
