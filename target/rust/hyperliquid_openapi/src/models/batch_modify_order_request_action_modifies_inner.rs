...
pub struct BatchModifyOrderRequestActionModifiesInner {
    /// Order ID to modify.
    #[serde(rename = "oid", skip_serializing_if = "Option::is_none")]
    pub oid: Option<i32>,
    #[serde(rename = "order", skip_serializing_if = "Option::is_none")]
    pub order: Option<Box<models::ModifyOrderRequestActionOrder>>,
}

impl BatchModifyOrderRequestActionModifiesInner {
    pub fn new() -> BatchModifyOrderRequestActionModifiesInner {
