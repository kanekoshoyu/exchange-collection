...
/// PlaceOrderRequestAction : The action object containing order details.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PlaceOrderRequestAction {
    /// Must be \"order\".
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<Type>,
    #[serde(rename = "orders", skip_serializing_if = "Option::is_none")]
    pub orders: Option<Vec<models::PlaceOrderRequestActionOrdersInner>>,
    /// Specifies the grouping type for the order.
    #[serde(rename = "grouping", skip_serializing_if = "Option::is_none")]
    pub grouping: Option<Grouping>,
}

impl PlaceOrderRequestAction {
    /// The action object containing order details.
    pub fn new() -> PlaceOrderRequestAction {
