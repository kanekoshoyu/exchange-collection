...
pub struct InitiateWithdrawalErrorResponseResponseData {
    /// Description of the error encountered during the withdrawal request
    #[serde(rename = "error", skip_serializing_if = "Option::is_none")]
    pub error: Option<String>,
}

impl InitiateWithdrawalErrorResponseResponseData {
    pub fn new() -> InitiateWithdrawalErrorResponseResponseData {
