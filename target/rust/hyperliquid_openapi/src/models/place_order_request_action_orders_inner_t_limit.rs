...
/// PlaceOrderRequestActionOrdersInnerTLimit : Limit order details.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PlaceOrderRequestActionOrdersInnerTLimit {
    /// Time-in-force for limit orders: - **ALO**: Add liquidity only (post only) - **IOC**: Immediate or cancel - **GTC**: Good til canceled 
    #[serde(rename = "tif", skip_serializing_if = "Option::is_none")]
    pub tif: Option<Tif>,
}

impl PlaceOrderRequestActionOrdersInnerTLimit {
    /// Limit order details.
    pub fn new() -> PlaceOrderRequestActionOrdersInnerTLimit {
        PlaceOrderRequestActionOrdersInnerTLimit {
            tif: None,
        }
    }
}
