...
pub struct BatchModifyOrderResponseResponseData {
    #[serde(rename = "statuses", skip_serializing_if = "Option::is_none")]
    pub statuses: Option<Vec<models::BatchModifyOrderResponseResponseDataStatusesInner>>,
}

impl BatchModifyOrderResponseResponseData {
    pub fn new() -> BatchModifyOrderResponseResponseData {
