...
pub struct WebSocketPostResponseDataResponse {
    /// Type of response data.
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<String>,
    #[serde(rename = "payload", skip_serializing_if = "Option::is_none")]
    pub payload: Option<Box<models::WebSocketPostResponseDataResponsePayload>>,
}

impl WebSocketPostResponseDataResponse {
    pub fn new() -> WebSocketPostResponseDataResponse {
