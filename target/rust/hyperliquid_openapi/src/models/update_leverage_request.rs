...
/// UpdateLeverageRequest : ### Request Schema The request body for updating cross or isolated leverage on a coin. 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateLeverageRequest {
    #[serde(rename = "action")]
    pub action: Box<models::UpdateLeverageRequestAction>,
...
impl UpdateLeverageRequest {
    ...
    pub fn new(action: models::UpdateLeverageRequestAction, nonce: i32, signature: models::ModifyOrderRequestSignature) -> UpdateLeverageRequest {
