...
/// CandleSnapshotRequest : Candle snapshot
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CandleSnapshotRequest {
    /// Request type to retrieve candle snapshots.
    #[serde(rename = "type")]
    pub r#type: String,
    #[serde(rename = "req")]
    pub req: Box<models::CandleSnapshotRequestReq>,
}

impl CandleSnapshotRequest {
    /// Candle snapshot
    pub fn new(r#type: String, req: models::CandleSnapshotRequestReq) -> CandleSnapshotRequest {
