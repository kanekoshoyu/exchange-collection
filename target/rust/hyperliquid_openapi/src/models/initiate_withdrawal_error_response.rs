...
/// InitiateWithdrawalErrorResponse : ### Error Response Schema The response body for an error encountered during the withdrawal request. 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct InitiateWithdrawalErrorResponse {
    /// Status indicating an error occurred.
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
    #[serde(rename = "response", skip_serializing_if = "Option::is_none")]
    pub response: Option<Box<models::InitiateWithdrawalErrorResponseResponse>>,
}

impl InitiateWithdrawalErrorResponse {
    /// ### Error Response Schema The response body for an error encountered during the withdrawal request. 
    pub fn new() -> InitiateWithdrawalErrorResponse {
