...
/// BatchModifyOrderErrorResponse : ### Error Response Schema The response body for an error encountered during the batch modify order request. 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct BatchModifyOrderErrorResponse {
    /// Status indicating an error occurred.
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
    #[serde(rename = "response", skip_serializing_if = "Option::is_none")]
    pub response: Option<Box<models::BatchModifyOrderErrorResponseResponse>>,
}

impl BatchModifyOrderErrorResponse {
    /// ### Error Response Schema The response body for an error encountered during the batch modify order request. 
    pub fn new() -> BatchModifyOrderErrorResponse {
