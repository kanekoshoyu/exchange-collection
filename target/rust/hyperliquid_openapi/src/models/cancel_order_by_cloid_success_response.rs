...
/// CancelOrderByCloidSuccessResponse : Response when the order(s) are successfully canceled by cloid.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CancelOrderByCloidSuccessResponse {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
    #[serde(rename = "response", skip_serializing_if = "Option::is_none")]
    pub response: Option<Box<models::CancelOrderByCloidSuccessResponseResponse>>,
}

impl CancelOrderByCloidSuccessResponse {
    /// Response when the order(s) are successfully canceled by cloid.
    pub fn new() -> CancelOrderByCloidSuccessResponse {
