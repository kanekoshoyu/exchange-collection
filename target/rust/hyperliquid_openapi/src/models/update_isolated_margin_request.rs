...
/// UpdateIsolatedMarginRequest : ### Request Schema The request body for adding or removing margin from an isolated position. 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateIsolatedMarginRequest {
    #[serde(rename = "action")]
    pub action: Box<models::UpdateIsolatedMarginRequestAction>,
...
impl UpdateIsolatedMarginRequest {
    ...
    pub fn new(action: models::UpdateIsolatedMarginRequestAction, nonce: i32, signature: models::ModifyOrderRequestSignature) -> UpdateIsolatedMarginRequest {
