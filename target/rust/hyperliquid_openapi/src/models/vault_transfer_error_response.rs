...
/// VaultTransferErrorResponse : ### Error Response Schema The response body for an error encountered during the vault transfer request. 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct VaultTransferErrorResponse {
    /// Status indicating an error occurred.
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
    #[serde(rename = "response", skip_serializing_if = "Option::is_none")]
    pub response: Option<Box<models::VaultTransferErrorResponseResponse>>,
}

impl VaultTransferErrorResponse {
    /// ### Error Response Schema The response body for an error encountered during the vault transfer request. 
    pub fn new() -> VaultTransferErrorResponse {
