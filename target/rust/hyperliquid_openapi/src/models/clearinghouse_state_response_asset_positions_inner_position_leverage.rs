...
/// ClearinghouseStateResponseAssetPositionsInnerPositionLeverage : Leverage details for the position.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ClearinghouseStateResponseAssetPositionsInnerPositionLeverage {
    /// The raw USD amount.
    #[serde(rename = "rawUsd", skip_serializing_if = "Option::is_none")]
    pub raw_usd: Option<String>,
    /// The type of leverage, e.g., isolated or cross.
...
impl ClearinghouseStateResponseAssetPositionsInnerPositionLeverage {
    /// Leverage details for the position.
    pub fn new() -> ClearinghouseStateResponseAssetPositionsInnerPositionLeverage {
        ClearinghouseStateResponseAssetPositionsInnerPositionLeverage {
            raw_usd: None,
            r#type: None,
            value: None,
        }
