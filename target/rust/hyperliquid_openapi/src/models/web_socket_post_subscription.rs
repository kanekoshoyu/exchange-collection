...
pub struct WebSocketPostSubscription {
    ...
    pub request: Option<Box<models::WebSocketPostSubscriptionRequest>>,
}

impl WebSocketPostSubscription {
    pub fn new() -> WebSocketPostSubscription {
