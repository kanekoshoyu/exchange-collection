...
/// UpdateLeverageResponse : ### Successful Response Schema The response body indicating the status of the update leverage request. 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateLeverageResponse {
    /// Status of the update leverage request.
