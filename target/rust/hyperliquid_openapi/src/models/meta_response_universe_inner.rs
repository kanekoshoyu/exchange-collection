...
pub struct MetaResponseUniverseInner {
    /// The name of the asset or universe.
    #[serde(rename = "name", skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    /// The number of decimal places for sizes.
    #[serde(rename = "szDecimals", skip_serializing_if = "Option::is_none")]
    pub sz_decimals: Option<i32>,
    /// The maximum leverage allowed for the asset.
    #[serde(rename = "maxLeverage", skip_serializing_if = "Option::is_none")]
    pub max_leverage: Option<i32>,
    /// Indicates if only isolated margin is allowed.
    #[serde(rename = "onlyIsolated", skip_serializing_if = "Option::is_none")]
    pub only_isolated: Option<bool>,
}

impl MetaResponseUniverseInner {
    pub fn new() -> MetaResponseUniverseInner {
