...
/// UserFundingOrLedgerUpdatesRequest : Retrieve a user's funding history or non-funding ledger updates
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UserFundingOrLedgerUpdatesRequest {
    /// The type of ledger updates to retrieve.
    #[serde(rename = "type")]
    pub r#type: Type,
...
impl UserFundingOrLedgerUpdatesRequest {
    /// Retrieve a user's funding history or non-funding ledger updates
    pub fn new(r#type: Type, user: String, start_time: i32) -> UserFundingOrLedgerUpdatesRequest {
