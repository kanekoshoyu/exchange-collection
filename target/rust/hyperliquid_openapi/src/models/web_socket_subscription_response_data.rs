...
pub struct WebSocketSubscriptionResponseData {
    #[serde(rename = "method", skip_serializing_if = "Option::is_none")]
    pub method: Option<String>,
    #[serde(rename = "subscription", skip_serializing_if = "Option::is_none")]
    pub subscription: Option<Box<models::WebSocketSubscriptionRequestSubscription>>,
    #[serde(rename = "responseData", skip_serializing_if = "Option::is_none")]
    pub response_data: Option<Box<models::WebSocketSubscriptionResponseDataResponseData>>,
}

impl WebSocketSubscriptionResponseData {
    pub fn new() -> WebSocketSubscriptionResponseData {
