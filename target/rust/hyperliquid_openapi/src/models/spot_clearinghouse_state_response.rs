...
/// SpotClearinghouseStateResponse : ### Response Schema This schema defines the structure of the response that contains the user's token balances. 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SpotClearinghouseStateResponse {
    #[serde(rename = "balances", skip_serializing_if = "Option::is_none")]
    pub balances: Option<Vec<models::SpotClearinghouseStateResponseBalancesInner>>,
}

impl SpotClearinghouseStateResponse {
    /// ### Response Schema This schema defines the structure of the response that contains the user's token balances. 
    pub fn new() -> SpotClearinghouseStateResponse {
