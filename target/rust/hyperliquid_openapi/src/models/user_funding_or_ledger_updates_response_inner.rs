...
pub struct UserFundingOrLedgerUpdatesResponseInner {
    #[serde(rename = "delta", skip_serializing_if = "Option::is_none")]
    pub delta: Option<Box<models::UserFundingOrLedgerUpdatesResponseInnerDelta>>,
...
impl UserFundingOrLedgerUpdatesResponseInner {
    pub fn new() -> UserFundingOrLedgerUpdatesResponseInner {
