...
/// CancelOrderByCloidRequestAction : The action object containing details to cancel orders by cloid.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CancelOrderByCloidRequestAction {
    /// Must be \"cancelByCloid\".
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<Type>,
    #[serde(rename = "cancels", skip_serializing_if = "Option::is_none")]
    pub cancels: Option<Vec<models::CancelOrderByCloidRequestActionCancelsInner>>,
}

impl CancelOrderByCloidRequestAction {
    /// The action object containing details to cancel orders by cloid.
    pub fn new() -> CancelOrderByCloidRequestAction {
        CancelOrderByCloidRequestAction {
            r#type: None,
            cancels: None,
        }
    }
