...
/// SpotMetaResponse : ### Response Schema This response schema contains spot metadata, including token details and trading pairs. 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SpotMetaResponse {
    #[serde(rename = "tokens", skip_serializing_if = "Option::is_none")]
    pub tokens: Option<Vec<models::SpotMetaResponseTokensInner>>,
    #[serde(rename = "universe", skip_serializing_if = "Option::is_none")]
    pub universe: Option<Vec<models::SpotMetaResponseUniverseInner>>,
}

impl SpotMetaResponse {
    /// ### Response Schema This response schema contains spot metadata, including token details and trading pairs. 
    pub fn new() -> SpotMetaResponse {
        SpotMetaResponse {
            tokens: None,
            universe: None,
        }
