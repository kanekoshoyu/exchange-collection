...
/// OrderStatusRequest : Query order status by oid or cloid
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct OrderStatusRequest {
    /// Address in 42-character hexadecimal format.
    #[serde(rename = "user")]
    pub user: String,
    /// Request type to query order status.
    #[serde(rename = "type")]
    pub r#type: String,
    /// Either a u64 representing the order id or a 16-byte hex string representing the client order id.
    #[serde(rename = "oid")]
    pub oid: String,
}
...
impl OrderStatusRequest {
    ...
    pub fn new(user: String, r#type: String, oid: String) -> OrderStatusRequest {
        OrderStatusRequest {
            user,
            r#type,
            oid,
