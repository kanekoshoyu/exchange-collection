...
pub struct ModifyOrderRequestActionOrderTOneOf1Trigger {
    ...
    /// Type of trigger, take-profit (tp) or stop-loss (sl).
    #[serde(rename = "tpsl", skip_serializing_if = "Option::is_none")]
    pub tpsl: Option<Tpsl>,
}

impl ModifyOrderRequestActionOrderTOneOf1Trigger {
    pub fn new() -> ModifyOrderRequestActionOrderTOneOf1Trigger {
