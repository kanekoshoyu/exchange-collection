...
pub struct SpotMetaResponseTokensInner {
    #[serde(rename = "name", skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[serde(rename = "szDecimals", skip_serializing_if = "Option::is_none")]
    pub sz_decimals: Option<i32>,
    #[serde(rename = "weiDecimals", skip_serializing_if = "Option::is_none")]
    pub wei_decimals: Option<i32>,
    ...
    #[serde(rename = "evmContract", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub evm_contract: Option<Option<String>>,
...
impl SpotMetaResponseTokensInner {
    pub fn new() -> SpotMetaResponseTokensInner {
