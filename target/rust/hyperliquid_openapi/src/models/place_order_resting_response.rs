...
/// PlaceOrderRestingResponse : Response when the order is placed and resting.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PlaceOrderRestingResponse {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
    #[serde(rename = "response", skip_serializing_if = "Option::is_none")]
    pub response: Option<Box<models::PlaceOrderRestingResponseResponse>>,
}

impl PlaceOrderRestingResponse {
    /// Response when the order is placed and resting.
    pub fn new() -> PlaceOrderRestingResponse {
