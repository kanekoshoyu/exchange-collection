...
/// PlaceOrderRequestActionOrdersInnerT : The type of order.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PlaceOrderRequestActionOrdersInnerT {
    #[serde(rename = "limit", skip_serializing_if = "Option::is_none")]
    pub limit: Option<Box<models::PlaceOrderRequestActionOrdersInnerTLimit>>,
    #[serde(rename = "trigger", skip_serializing_if = "Option::is_none")]
    pub trigger: Option<Box<models::PlaceOrderRequestActionOrdersInnerTTrigger>>,
}

impl PlaceOrderRequestActionOrdersInnerT {
    /// The type of order.
    pub fn new() -> PlaceOrderRequestActionOrdersInnerT {
        PlaceOrderRequestActionOrdersInnerT {
            limit: None,
            trigger: None,
        }
    }
