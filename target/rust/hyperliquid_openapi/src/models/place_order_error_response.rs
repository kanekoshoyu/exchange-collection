...
/// PlaceOrderErrorResponse : Response when there is an error in order placement.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PlaceOrderErrorResponse {
...
impl PlaceOrderErrorResponse {
    /// Response when there is an error in order placement.
    pub fn new() -> PlaceOrderErrorResponse {
