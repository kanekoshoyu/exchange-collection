...
pub struct L1SpotTransferErrorResponseResponseData {
    /// Description of the error encountered during the L1 spot transfer request.
    #[serde(rename = "error", skip_serializing_if = "Option::is_none")]
    pub error: Option<String>,
}

impl L1SpotTransferErrorResponseResponseData {
    pub fn new() -> L1SpotTransferErrorResponseResponseData {
