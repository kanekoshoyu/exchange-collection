...
/// VaultTransferResponse : ### Successful Response Schema The response body indicating the status of the vault transfer request. 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct VaultTransferResponse {
    /// Status of the vault transfer request.
