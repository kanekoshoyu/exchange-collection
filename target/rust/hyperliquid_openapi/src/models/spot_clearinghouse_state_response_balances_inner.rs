...
pub struct SpotClearinghouseStateResponseBalancesInner {
    /// The name of the token (e.g., USDC, PURR).
    #[serde(rename = "coin", skip_serializing_if = "Option::is_none")]
    pub coin: Option<String>,
    /// The index of the token.
    #[serde(rename = "token", skip_serializing_if = "Option::is_none")]
    pub token: Option<i32>,
    /// The amount of the token that is on hold.
    #[serde(rename = "hold", skip_serializing_if = "Option::is_none")]
    pub hold: Option<String>,
    /// The total balance of the token.
    #[serde(rename = "total", skip_serializing_if = "Option::is_none")]
    pub total: Option<String>,
    /// The notional value at entry for the token.
    #[serde(rename = "entryNtl", skip_serializing_if = "Option::is_none")]
    pub entry_ntl: Option<String>,
}

impl SpotClearinghouseStateResponseBalancesInner {
    pub fn new() -> SpotClearinghouseStateResponseBalancesInner {
