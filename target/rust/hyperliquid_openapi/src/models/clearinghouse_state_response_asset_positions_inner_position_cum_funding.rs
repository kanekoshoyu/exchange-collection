...
/// ClearinghouseStateResponseAssetPositionsInnerPositionCumFunding : Cumulative funding details.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ClearinghouseStateResponseAssetPositionsInnerPositionCumFunding {
    /// All-time cumulative funding.
    #[serde(rename = "allTime", skip_serializing_if = "Option::is_none")]
    pub all_time: Option<String>,
    /// Cumulative funding since the last change.
    ...
    #[serde(rename = "sinceOpen", skip_serializing_if = "Option::is_none")]
    pub since_open: Option<String>,
}

impl ClearinghouseStateResponseAssetPositionsInnerPositionCumFunding {
    /// Cumulative funding details.
    pub fn new() -> ClearinghouseStateResponseAssetPositionsInnerPositionCumFunding {
        ClearinghouseStateResponseAssetPositionsInnerPositionCumFunding {
            all_time: None,
            since_change: None,
            since_open: None,
        }
