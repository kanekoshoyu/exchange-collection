...
pub struct UpdateLeverageRequestAction {
    /// Must be \"updateLeverage\".
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<String>,
    /// Index of the coin for which leverage is being updated.
    #[serde(rename = "asset", skip_serializing_if = "Option::is_none")]
    pub asset: Option<i32>,
    /// Whether to update cross-leverage. Set to `true` for cross, `false` for isolated.
    #[serde(rename = "isCross", skip_serializing_if = "Option::is_none")]
    pub is_cross: Option<bool>,
    /// New leverage value, subject to leverage constraints on that coin.
    #[serde(rename = "leverage", skip_serializing_if = "Option::is_none")]
    pub leverage: Option<i32>,
}

impl UpdateLeverageRequestAction {
    pub fn new() -> UpdateLeverageRequestAction {
