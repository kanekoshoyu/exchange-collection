...
/// ModifyOrderRequestActionOrderTOneOf1 : Trigger order type with market option.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ModifyOrderRequestActionOrderTOneOf1 {
    #[serde(rename = "trigger", skip_serializing_if = "Option::is_none")]
    pub trigger: Option<Box<models::ModifyOrderRequestActionOrderTOneOf1Trigger>>,
}

impl ModifyOrderRequestActionOrderTOneOf1 {
    /// Trigger order type with market option.
    pub fn new() -> ModifyOrderRequestActionOrderTOneOf1 {
        ModifyOrderRequestActionOrderTOneOf1 {
            trigger: None,
        }
    }
}
