...
#[serde(untagged)]
pub enum WsPostRequest {
    WebSocketSubscriptionRequest(Box<models::WebSocketSubscriptionRequest>),
    WebSocketPostSubscription(Box<models::WebSocketPostSubscription>),
    OrderSignedRequest(Box<models::OrderSignedRequest>),
}

impl Default for WsPostRequest {
    fn default() -> Self {
        Self::WebSocketSubscriptionRequest(Default::default())
    }
}
