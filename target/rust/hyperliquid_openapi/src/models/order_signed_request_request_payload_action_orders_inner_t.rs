...
pub struct OrderSignedRequestRequestPayloadActionOrdersInnerT {
    #[serde(rename = "limit", skip_serializing_if = "Option::is_none")]
    pub limit: Option<Box<models::OrderSignedRequestRequestPayloadActionOrdersInnerTLimit>>,
}

impl OrderSignedRequestRequestPayloadActionOrdersInnerT {
    pub fn new() -> OrderSignedRequestRequestPayloadActionOrdersInnerT {
