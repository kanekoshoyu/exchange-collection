...
/// PlaceOrderRequestActionOrdersInnerTTrigger : Trigger order details.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PlaceOrderRequestActionOrdersInnerTTrigger {
    /// Indicates if the trigger order is a market order.
    #[serde(rename = "isMarket", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "tpsl", skip_serializing_if = "Option::is_none")]
    pub tpsl: Option<Tpsl>,
}

impl PlaceOrderRequestActionOrdersInnerTTrigger {
    /// Trigger order details.
    pub fn new() -> PlaceOrderRequestActionOrdersInnerTTrigger {
        PlaceOrderRequestActionOrdersInnerTTrigger {
            is_market: None,
            trigger_px: None,
            tpsl: None,
        }
