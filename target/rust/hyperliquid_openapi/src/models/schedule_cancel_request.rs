...
/// ScheduleCancelRequest : ### Request Schema The request body for scheduling a cancel-all operation. Setting `time` to `null` will remove any outstanding scheduled cancel operation. 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ScheduleCancelRequest {
    /// Must be \"scheduleCancel\".
    #[serde(rename = "type")]
    pub r#type: String,
    /// The time (in Unix milliseconds) at which the cancel-all operation should occur. Setting this to `null` will remove any outstanding scheduled cancel operation. 
...
impl ScheduleCancelRequest {
    ...
    pub fn new(r#type: String, time: Option<i64>) -> ScheduleCancelRequest {
