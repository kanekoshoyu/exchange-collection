...
pub struct CancelOrderByCloidSuccessResponseResponse {
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<String>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::CancelOrderSuccessResponseResponseData>>,
}

impl CancelOrderByCloidSuccessResponseResponse {
    pub fn new() -> CancelOrderByCloidSuccessResponseResponse {
        CancelOrderByCloidSuccessResponseResponse {
            r#type: None,
            data: None,
        }
    }
