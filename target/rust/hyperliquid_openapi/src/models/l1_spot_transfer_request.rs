...
/// L1SpotTransferRequest : ### Request Schema The request body for sending spot assets to another address without touching the EVM bridge. 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct L1SpotTransferRequest {
    #[serde(rename = "action")]
    pub action: Box<models::L1SpotTransferRequestAction>,
...
impl L1SpotTransferRequest {
    /// ### Request Schema The request body for sending spot assets to another address without touching the EVM bridge. 
    pub fn new(action: models::L1SpotTransferRequestAction, nonce: i32, signature: serde_json::Value) -> L1SpotTransferRequest {
