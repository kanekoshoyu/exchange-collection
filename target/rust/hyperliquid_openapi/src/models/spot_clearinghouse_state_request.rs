...
/// SpotClearinghouseStateRequest : ### Request Schema This schema is used to retrieve a user's token balances. 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SpotClearinghouseStateRequest {
    /// The type of request. Use \"spotClearinghouseState\" to retrieve the user's token balances. 
    #[serde(rename = "type")]
    pub r#type: Type,
    /// The onchain address in a 42-character hexadecimal format, e.g., 0x0000000000000000000000000000000000000000. 
    #[serde(rename = "user")]
    pub user: String,
}
...
impl SpotClearinghouseStateRequest {
    ...
    pub fn new(r#type: Type, user: String) -> SpotClearinghouseStateRequest {
