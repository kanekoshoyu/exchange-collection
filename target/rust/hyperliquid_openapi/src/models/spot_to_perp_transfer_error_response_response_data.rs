...
pub struct SpotToPerpTransferErrorResponseResponseData {
    /// Description of the error encountered during the transfer request.
    #[serde(rename = "error", skip_serializing_if = "Option::is_none")]
    pub error: Option<String>,
}

impl SpotToPerpTransferErrorResponseResponseData {
    pub fn new() -> SpotToPerpTransferErrorResponseResponseData {
