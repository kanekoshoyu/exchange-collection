...
pub struct OrderSignedRequestRequestPayloadActionOrdersInnerTLimit {
    /// Time in force for the order.
    #[serde(rename = "tif", skip_serializing_if = "Option::is_none")]
    pub tif: Option<String>,
}

impl OrderSignedRequestRequestPayloadActionOrdersInnerTLimit {
    pub fn new() -> OrderSignedRequestRequestPayloadActionOrdersInnerTLimit {
