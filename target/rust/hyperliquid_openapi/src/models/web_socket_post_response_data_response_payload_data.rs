...
pub struct WebSocketPostResponseDataResponsePayloadData {
    ...
    pub time: Option<i32>,
    /// Order book levels for the coin.
    #[serde(rename = "levels", skip_serializing_if = "Option::is_none")]
    pub levels: Option<Vec<Vec<models::WsLevel>>>,
}

impl WebSocketPostResponseDataResponsePayloadData {
    pub fn new() -> WebSocketPostResponseDataResponsePayloadData {
