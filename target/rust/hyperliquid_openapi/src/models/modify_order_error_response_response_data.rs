...
pub struct ModifyOrderErrorResponseResponseData {
    /// Description of the error encountered during the modify order request.
    #[serde(rename = "error", skip_serializing_if = "Option::is_none")]
    pub error: Option<String>,
}

impl ModifyOrderErrorResponseResponseData {
    pub fn new() -> ModifyOrderErrorResponseResponseData {
