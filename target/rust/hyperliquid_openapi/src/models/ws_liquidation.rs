...
pub struct WsLiquidation {
    ...
    pub lid: Option<f64>,
    #[serde(rename = "liquidator", skip_serializing_if = "Option::is_none")]
    pub liquidator: Option<String>,
    #[serde(rename = "liquidated_user", skip_serializing_if = "Option::is_none")]
    pub liquidated_user: Option<String>,
    #[serde(rename = "liquidated_ntl_pos", skip_serializing_if = "Option::is_none")]
    pub liquidated_ntl_pos: Option<String>,
    #[serde(rename = "liquidated_account_value", skip_serializing_if = "Option::is_none")]
    pub liquidated_account_value: Option<String>,
}

impl WsLiquidation {
    pub fn new() -> WsLiquidation {
        WsLiquidation {
            lid: None,
            liquidator: None,
