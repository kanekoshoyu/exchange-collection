...
pub struct PlaceOrderFilledResponseResponseDataStatusesInner {
    #[serde(rename = "filled", skip_serializing_if = "Option::is_none")]
    pub filled: Option<Box<models::PlaceOrderFilledResponseResponseDataStatusesInnerFilled>>,
}

impl PlaceOrderFilledResponseResponseDataStatusesInner {
    pub fn new() -> PlaceOrderFilledResponseResponseDataStatusesInner {
