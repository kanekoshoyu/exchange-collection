...
/// PlaceOrderRequest : ### Request Schema The request body for placing an order. You can specify various order types, conditions, and settings. 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PlaceOrderRequest {
    #[serde(rename = "action")]
    pub action: Box<models::PlaceOrderRequestAction>,
...
impl PlaceOrderRequest {
    ...
    pub fn new(action: models::PlaceOrderRequestAction, nonce: f64, signature: serde_json::Value) -> PlaceOrderRequest {
        PlaceOrderRequest {
