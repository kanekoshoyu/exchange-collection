...
/// SpotMetaAndAssetCtxsRequest : ### Request Schema This request schema is used to retrieve spot asset contexts. 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SpotMetaAndAssetCtxsRequest {
    /// The type of request. Use \"spotMetaAndAssetCtxs\" to retrieve spot asset contexts. 
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<String>,
}

impl SpotMetaAndAssetCtxsRequest {
    /// ### Request Schema This request schema is used to retrieve spot asset contexts. 
    pub fn new() -> SpotMetaAndAssetCtxsRequest {
