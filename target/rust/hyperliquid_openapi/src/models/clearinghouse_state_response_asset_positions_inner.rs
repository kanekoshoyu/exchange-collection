...
pub struct ClearinghouseStateResponseAssetPositionsInner {
    #[serde(rename = "position", skip_serializing_if = "Option::is_none")]
    pub position: Option<Box<models::ClearinghouseStateResponseAssetPositionsInnerPosition>>,
    /// The type of position, e.g., one-way or hedge.
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<String>,
}

impl ClearinghouseStateResponseAssetPositionsInner {
    pub fn new() -> ClearinghouseStateResponseAssetPositionsInner {
