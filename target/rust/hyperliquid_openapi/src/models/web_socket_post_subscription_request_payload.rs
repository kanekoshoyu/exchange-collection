...
/// WebSocketPostSubscriptionRequestPayload : The payload of the request, varying by request type.
/// The payload of the request, varying by request type.
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(untagged)]
pub enum WebSocketPostSubscriptionRequestPayload {
    InfoPayload(Box<models::InfoPayload>),
    ActionPayload(Box<models::ActionPayload>),
}

impl Default for WebSocketPostSubscriptionRequestPayload {
    fn default() -> Self {
        Self::InfoPayload(Default::default())
    }
}
