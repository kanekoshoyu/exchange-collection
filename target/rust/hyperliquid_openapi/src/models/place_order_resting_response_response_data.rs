...
pub struct PlaceOrderRestingResponseResponseData {
    #[serde(rename = "statuses", skip_serializing_if = "Option::is_none")]
    pub statuses: Option<Vec<models::PlaceOrderRestingResponseResponseDataStatusesInner>>,
}

impl PlaceOrderRestingResponseResponseData {
    pub fn new() -> PlaceOrderRestingResponseResponseData {
