...
/// FrontendOpenOrdersRequest : Retrieve a user's open orders with additional frontend info
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct FrontendOpenOrdersRequest {
    /// Request type to see frontend open orders.
    #[serde(rename = "type")]
    pub r#type: String,
...
impl FrontendOpenOrdersRequest {
    ...
    pub fn new(r#type: String, user: String) -> FrontendOpenOrdersRequest {
