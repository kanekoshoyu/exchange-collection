...
pub struct OrderSignedResponseRequestPayloadResponseDataStatusesInner {
    #[serde(rename = "resting", skip_serializing_if = "Option::is_none")]
    pub resting: Option<Box<models::OrderSignedResponseRequestPayloadResponseDataStatusesInnerResting>>,
}

impl OrderSignedResponseRequestPayloadResponseDataStatusesInner {
    pub fn new() -> OrderSignedResponseRequestPayloadResponseDataStatusesInner {
