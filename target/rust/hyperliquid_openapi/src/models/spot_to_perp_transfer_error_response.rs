...
/// SpotToPerpTransferErrorResponse : ### Error Response Schema The response body for an error encountered during the transfer request. 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SpotToPerpTransferErrorResponse {
    /// Status indicating an error occurred.
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
    #[serde(rename = "response", skip_serializing_if = "Option::is_none")]
    pub response: Option<Box<models::SpotToPerpTransferErrorResponseResponse>>,
}

impl SpotToPerpTransferErrorResponse {
    /// ### Error Response Schema The response body for an error encountered during the transfer request. 
    pub fn new() -> SpotToPerpTransferErrorResponse {
