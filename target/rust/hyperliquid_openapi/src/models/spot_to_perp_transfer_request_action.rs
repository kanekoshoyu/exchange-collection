...
pub struct SpotToPerpTransferRequestAction {
    /// Must be \"spotUser\".
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<String>,
    #[serde(rename = "classTransfer")]
    pub class_transfer: Box<models::SpotToPerpTransferRequestActionClassTransfer>,
}

impl SpotToPerpTransferRequestAction {
    pub fn new(class_transfer: models::SpotToPerpTransferRequestActionClassTransfer) -> SpotToPerpTransferRequestAction {
        SpotToPerpTransferRequestAction {
            r#type: None,
            class_transfer: Box::new(class_transfer),
        }
    }
}
