...
pub struct CancelOrderByCloidRequestActionCancelsInner {
    /// The asset associated with the order.
    #[serde(rename = "asset", skip_serializing_if = "Option::is_none")]
    pub asset: Option<f64>,
    /// The Client Order ID (cloid) to identify the order to cancel.
    #[serde(rename = "cloid", skip_serializing_if = "Option::is_none")]
    pub cloid: Option<String>,
}

impl CancelOrderByCloidRequestActionCancelsInner {
    pub fn new() -> CancelOrderByCloidRequestActionCancelsInner {
