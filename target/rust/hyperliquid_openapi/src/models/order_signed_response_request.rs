...
pub struct OrderSignedResponseRequest {
    /// Type of the request.
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<String>,
    #[serde(rename = "payload", skip_serializing_if = "Option::is_none")]
    pub payload: Option<Box<models::OrderSignedResponseRequestPayload>>,
}

impl OrderSignedResponseRequest {
    pub fn new() -> OrderSignedResponseRequest {
