...
pub struct UpdateIsolatedMarginErrorResponseResponseData {
    /// Description of the error encountered during the update isolated margin request
    #[serde(rename = "error", skip_serializing_if = "Option::is_none")]
    pub error: Option<String>,
}

impl UpdateIsolatedMarginErrorResponseResponseData {
    pub fn new() -> UpdateIsolatedMarginErrorResponseResponseData {
