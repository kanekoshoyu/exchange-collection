...
pub struct ClearinghouseStateResponse {
    /// Details of the user's open positions.
    #[serde(rename = "assetPositions", skip_serializing_if = "Option::is_none")]
    pub asset_positions: Option<Vec<models::ClearinghouseStateResponseAssetPositionsInner>>,
    /// The amount of cross maintenance margin used.
    #[serde(rename = "crossMaintenanceMarginUsed", skip_serializing_if = "Option::is_none")]
    pub cross_maintenance_margin_used: Option<String>,
    #[serde(rename = "crossMarginSummary", skip_serializing_if = "Option::is_none")]
    pub cross_margin_summary: Option<Box<models::ClearinghouseStateResponseCrossMarginSummary>>,
    #[serde(rename = "marginSummary", skip_serializing_if = "Option::is_none")]
    pub margin_summary: Option<Box<models::ClearinghouseStateResponseMarginSummary>>,
...
impl ClearinghouseStateResponse {
    pub fn new() -> ClearinghouseStateResponse {
