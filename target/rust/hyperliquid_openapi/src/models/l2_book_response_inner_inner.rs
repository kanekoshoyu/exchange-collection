...
pub struct L2BookResponseInnerInner {
    /// The price level.
    #[serde(rename = "px", skip_serializing_if = "Option::is_none")]
    pub px: Option<String>,
    /// The size of the order at this price level.
    #[serde(rename = "sz", skip_serializing_if = "Option::is_none")]
    pub sz: Option<String>,
    /// The order rank or identifier.
    #[serde(rename = "n", skip_serializing_if = "Option::is_none")]
    pub n: Option<i32>,
}

impl L2BookResponseInnerInner {
    pub fn new() -> L2BookResponseInnerInner {
