...
/// UserFillsByTimeRequest : Retrieve a user's fills by time
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UserFillsByTimeRequest {
    /// Request type to retrieve user fills by time.
    #[serde(rename = "type")]
    pub r#type: String,
...
impl UserFillsByTimeRequest {
    ...
    pub fn new(r#type: String, user: String, start_time: i32) -> UserFillsByTimeRequest {
