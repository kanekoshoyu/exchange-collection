...
/// ModifyOrderResponse : ### Response Schema The response body indicating the status of the modify order request. 
...
pub struct ModifyOrderResponse {
    ...
    pub response: Option<Box<models::ModifyOrderResponseResponse>>,
}
