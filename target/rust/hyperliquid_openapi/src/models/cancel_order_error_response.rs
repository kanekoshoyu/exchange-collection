...
/// CancelOrderErrorResponse : Response when there is an error in canceling the order(s).
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CancelOrderErrorResponse {
...
impl CancelOrderErrorResponse {
    /// Response when there is an error in canceling the order(s).
    pub fn new() -> CancelOrderErrorResponse {
