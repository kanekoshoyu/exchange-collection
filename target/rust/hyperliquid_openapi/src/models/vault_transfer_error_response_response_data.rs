...
pub struct VaultTransferErrorResponseResponseData {
    /// Description of the error encountered during the vault transfer request
    #[serde(rename = "error", skip_serializing_if = "Option::is_none")]
    pub error: Option<String>,
}

impl VaultTransferErrorResponseResponseData {
    pub fn new() -> VaultTransferErrorResponseResponseData {
