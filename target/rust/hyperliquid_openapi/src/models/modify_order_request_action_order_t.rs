...
/// ModifyOrderRequestActionOrderT : Order type details.
/// Order type details.
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ModifyOrderRequestActionOrderT {
    ModifyOrderRequestActionOrderTOneOf(Box<models::ModifyOrderRequestActionOrderTOneOf>),
    ModifyOrderRequestActionOrderTOneOf1(Box<models::ModifyOrderRequestActionOrderTOneOf1>),
}

impl Default for ModifyOrderRequestActionOrderT {
    fn default() -> Self {
        Self::ModifyOrderRequestActionOrderTOneOf(Default::default())
    }
}
