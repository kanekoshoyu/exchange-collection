...
pub struct WebSocketPostResponseDataResponsePayload {
    /// Type of data contained in the payload.
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<String>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::WebSocketPostResponseDataResponsePayloadData>>,
}

impl WebSocketPostResponseDataResponsePayload {
    pub fn new() -> WebSocketPostResponseDataResponsePayload {
