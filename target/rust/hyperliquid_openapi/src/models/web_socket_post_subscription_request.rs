...
pub struct WebSocketPostSubscriptionRequest {
    /// The type of request.
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<Type>,
    #[serde(rename = "payload", skip_serializing_if = "Option::is_none")]
    pub payload: Option<Box<models::WebSocketPostSubscriptionRequestPayload>>,
}

impl WebSocketPostSubscriptionRequest {
    pub fn new() -> WebSocketPostSubscriptionRequest {
