...
pub struct L1SpotTransferRequestAction {
    /// Must be \"spotSend\".
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<String>,
    /// The Hyperliquid chain to use, set to \"Mainnet\" or \"Testnet\".
    #[serde(rename = "hyperliquidChain", skip_serializing_if = "Option::is_none")]
    pub hyperliquid_chain: Option<String>,
    /// The ID of the chain used when signing in hexadecimal format (e.g., \"0xa4b1\" for Arbitrum).
    #[serde(rename = "signatureChainId", skip_serializing_if = "Option::is_none")]
    pub signature_chain_id: Option<String>,
    /// The address to send spot assets to in 42-character hexadecimal format.
    #[serde(rename = "destination", skip_serializing_if = "Option::is_none")]
    pub destination: Option<String>,
    /// The token name and ID, formatted as \"tokenName:tokenId\".
    #[serde(rename = "token", skip_serializing_if = "Option::is_none")]
    pub token: Option<String>,
    /// The amount of the token to send as a string.
    #[serde(rename = "amount", skip_serializing_if = "Option::is_none")]
    pub amount: Option<String>,
    /// Current timestamp in milliseconds as a number, should match nonce.
    #[serde(rename = "time", skip_serializing_if = "Option::is_none")]
    pub time: Option<i32>,
}

impl L1SpotTransferRequestAction {
    pub fn new() -> L1SpotTransferRequestAction {
