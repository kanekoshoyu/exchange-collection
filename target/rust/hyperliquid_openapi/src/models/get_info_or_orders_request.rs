...
#[serde(untagged)]
pub enum GetInfoOrOrdersRequest {
    MarketDataRequest(Box<models::MarketDataRequest>),
    OpenOrdersRequest(Box<models::OpenOrdersRequest>),
    FrontendOpenOrdersRequest(Box<models::FrontendOpenOrdersRequest>),
    UserFillsRequest(Box<models::UserFillsRequest>),
    UserFillsByTimeRequest(Box<models::UserFillsByTimeRequest>),
    OrderStatusRequest(Box<models::OrderStatusRequest>),
    L2BookRequest(Box<models::L2BookRequest>),
    CandleSnapshotRequest(Box<models::CandleSnapshotRequest>),
    MetaRequest(Box<models::MetaRequest>),
    MetaAndAssetCtxsRequest(Box<models::MetaAndAssetCtxsRequest>),
    ClearinghouseStateRequest(Box<models::ClearinghouseStateRequest>),
    UserFundingOrLedgerUpdatesRequest(Box<models::UserFundingOrLedgerUpdatesRequest>),
    FundingHistoryRequest(Box<models::FundingHistoryRequest>),
    SpotMetaRequest(Box<models::SpotMetaRequest>),
    SpotMetaAndAssetCtxsRequest(Box<models::SpotMetaAndAssetCtxsRequest>),
    SpotClearinghouseStateRequest(Box<models::SpotClearinghouseStateRequest>),
}

impl Default for GetInfoOrOrdersRequest {
    fn default() -> Self {
        Self::MarketDataRequest(Default::default())
    }
}
