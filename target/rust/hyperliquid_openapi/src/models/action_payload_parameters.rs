...
/// ActionPayloadParameters : Parameters for the action.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ActionPayloadParameters {
    /// A parameter for the action.
    #[serde(rename = "param1", skip_serializing_if = "Option::is_none")]
    pub param1: Option<String>,
    /// Another parameter for the action.
    #[serde(rename = "param2", skip_serializing_if = "Option::is_none")]
    pub param2: Option<i32>,
}

impl ActionPayloadParameters {
    /// Parameters for the action.
    pub fn new() -> ActionPayloadParameters {
        ActionPayloadParameters {
            param1: None,
            param2: None,
        }
    }
