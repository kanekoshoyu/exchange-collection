...
/// ClearinghouseStateResponseCrossMarginSummary : Summary of the cross margin account.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ClearinghouseStateResponseCrossMarginSummary {
    /// The total account value.
    #[serde(rename = "accountValue", skip_serializing_if = "Option::is_none")]
    pub account_value: Option<String>,
    /// The total margin used.
    #[serde(rename = "totalMarginUsed", skip_serializing_if = "Option::is_none")]
    pub total_margin_used: Option<String>,
    /// The total notional position.
    #[serde(rename = "totalNtlPos", skip_serializing_if = "Option::is_none")]
    pub total_ntl_pos: Option<String>,
    /// The total raw USD value.
    #[serde(rename = "totalRawUsd", skip_serializing_if = "Option::is_none")]
    pub total_raw_usd: Option<String>,
}

impl ClearinghouseStateResponseCrossMarginSummary {
    /// Summary of the cross margin account.
    pub fn new() -> ClearinghouseStateResponseCrossMarginSummary {
        ClearinghouseStateResponseCrossMarginSummary {
            account_value: None,
