...
/// PlaceOrderFilledResponse : Response when the order is successfully filled.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PlaceOrderFilledResponse {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
    #[serde(rename = "response", skip_serializing_if = "Option::is_none")]
    pub response: Option<Box<models::PlaceOrderFilledResponseResponse>>,
}

impl PlaceOrderFilledResponse {
    /// Response when the order is successfully filled.
    pub fn new() -> PlaceOrderFilledResponse {
