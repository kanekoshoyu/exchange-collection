...
pub struct ModifyOrderRequestSignature {
    /// If trading on behalf of a vault, its Onchain address in 42-character hexadecimal format. Example: 0x0000000000000000000000000000000000000000 
    #[serde(rename = "vaultAddress", skip_serializing_if = "Option::is_none")]
    pub vault_address: Option<String>,
}

impl ModifyOrderRequestSignature {
    pub fn new() -> ModifyOrderRequestSignature {
