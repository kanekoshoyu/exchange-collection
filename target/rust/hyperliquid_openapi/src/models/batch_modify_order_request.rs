...
/// BatchModifyOrderRequest : ### Request Schema The request body for modifying multiple existing orders. 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct BatchModifyOrderRequest {
    #[serde(rename = "action")]
    pub action: Box<models::BatchModifyOrderRequestAction>,
    /// Recommended to use the current timestamp in milliseconds.
    #[serde(rename = "nonce")]
    pub nonce: i32,
    #[serde(rename = "signature")]
    pub signature: Box<models::ModifyOrderRequestSignature>,
}

impl BatchModifyOrderRequest {
    /// ### Request Schema The request body for modifying multiple existing orders. 
    pub fn new(action: models::BatchModifyOrderRequestAction, nonce: i32, signature: models::ModifyOrderRequestSignature) -> BatchModifyOrderRequest {
