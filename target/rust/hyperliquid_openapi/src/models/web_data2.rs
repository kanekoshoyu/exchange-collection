...
pub struct WebData2 {
    #[serde(rename = "exampleProperty1", skip_serializing_if = "Option::is_none")]
    pub example_property1: Option<String>,
    #[serde(rename = "exampleProperty2", skip_serializing_if = "Option::is_none")]
    pub example_property2: Option<i32>,
}

impl WebData2 {
    pub fn new() -> WebData2 {
        WebData2 {
            example_property1: None,
            example_property2: None,
        }
    }
}
