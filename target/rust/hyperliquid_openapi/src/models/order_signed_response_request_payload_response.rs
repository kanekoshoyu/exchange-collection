...
pub struct OrderSignedResponseRequestPayloadResponse {
    /// The type of response data.
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<String>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::OrderSignedResponseRequestPayloadResponseData>>,
}

impl OrderSignedResponseRequestPayloadResponse {
    pub fn new() -> OrderSignedResponseRequestPayloadResponse {
