...
/// CancelOrderSuccessResponse : Response when the order(s) are successfully canceled.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CancelOrderSuccessResponse {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
    #[serde(rename = "response", skip_serializing_if = "Option::is_none")]
    pub response: Option<Box<models::CancelOrderSuccessResponseResponse>>,
}

impl CancelOrderSuccessResponse {
    /// Response when the order(s) are successfully canceled.
    pub fn new() -> CancelOrderSuccessResponse {
