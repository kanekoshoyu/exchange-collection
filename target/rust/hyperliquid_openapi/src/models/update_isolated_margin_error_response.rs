...
/// UpdateIsolatedMarginErrorResponse : ### Error Response Schema The response body for an error encountered during the update isolated margin request. 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateIsolatedMarginErrorResponse {
    /// Status indicating an error occurred.
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
    #[serde(rename = "response", skip_serializing_if = "Option::is_none")]
    pub response: Option<Box<models::UpdateIsolatedMarginErrorResponseResponse>>,
}

impl UpdateIsolatedMarginErrorResponse {
    /// ### Error Response Schema The response body for an error encountered during the update isolated margin request. 
    pub fn new() -> UpdateIsolatedMarginErrorResponse {
