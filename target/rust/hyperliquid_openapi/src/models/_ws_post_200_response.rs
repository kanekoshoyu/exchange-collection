...
#[serde(untagged)]
pub enum WsPost200Response {
    WebSocketMessage(Box<models::WebSocketMessage>),
    WebSocketResponse(Box<models::WebSocketResponse>),
    WebSocketSubscriptionResponse(Box<models::WebSocketSubscriptionResponse>),
    WebSocketPostResponse(Box<models::WebSocketPostResponse>),
    OrderSignedResponse(Box<models::OrderSignedResponse>),
}

impl Default for WsPost200Response {
    fn default() -> Self {
        Self::WebSocketMessage(Default::default())
    }
}
