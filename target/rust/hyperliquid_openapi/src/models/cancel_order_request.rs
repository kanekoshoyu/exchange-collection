...
/// CancelOrderRequest : ### Request Schema The request body for canceling orders. You can specify one or more orders to cancel using their order IDs (oid). 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CancelOrderRequest {
    #[serde(rename = "action")]
    pub action: Box<models::CancelOrderRequestAction>,
...
impl CancelOrderRequest {
    ...
    pub fn new(action: models::CancelOrderRequestAction, nonce: f64, signature: serde_json::Value) -> CancelOrderRequest {
        CancelOrderRequest {
