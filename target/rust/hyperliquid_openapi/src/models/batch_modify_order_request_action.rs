...
pub struct BatchModifyOrderRequestAction {
    /// Must be \"batchModify\".
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<String>,
    #[serde(rename = "modifies", skip_serializing_if = "Option::is_none")]
    pub modifies: Option<Vec<models::BatchModifyOrderRequestActionModifiesInner>>,
}

impl BatchModifyOrderRequestAction {
    pub fn new() -> BatchModifyOrderRequestAction {
