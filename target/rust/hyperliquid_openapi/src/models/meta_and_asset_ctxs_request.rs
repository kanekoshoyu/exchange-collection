...
/// MetaAndAssetCtxsRequest : Retrieve perpetuals asset contexts (includes mark price, current funding, open interest, etc)
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct MetaAndAssetCtxsRequest {
    /// Request type to retrieve metadata and asset contexts.
    #[serde(rename = "type")]
    pub r#type: String,
}

impl MetaAndAssetCtxsRequest {
    /// Retrieve perpetuals asset contexts (includes mark price, current funding, open interest, etc)
    pub fn new(r#type: String) -> MetaAndAssetCtxsRequest {
