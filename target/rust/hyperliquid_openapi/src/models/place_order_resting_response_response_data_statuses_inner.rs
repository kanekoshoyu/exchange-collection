...
pub struct PlaceOrderRestingResponseResponseDataStatusesInner {
    #[serde(rename = "resting", skip_serializing_if = "Option::is_none")]
    pub resting: Option<Box<models::PlaceOrderRestingResponseResponseDataStatusesInnerResting>>,
}

impl PlaceOrderRestingResponseResponseDataStatusesInner {
    pub fn new() -> PlaceOrderRestingResponseResponseDataStatusesInner {
