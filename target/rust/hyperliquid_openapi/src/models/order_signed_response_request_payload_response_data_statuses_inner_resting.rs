...
pub struct OrderSignedResponseRequestPayloadResponseDataStatusesInnerResting {
    /// Order ID.
    #[serde(rename = "oid", skip_serializing_if = "Option::is_none")]
    pub oid: Option<i32>,
}

impl OrderSignedResponseRequestPayloadResponseDataStatusesInnerResting {
    pub fn new() -> OrderSignedResponseRequestPayloadResponseDataStatusesInnerResting {
