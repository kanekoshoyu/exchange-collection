...
pub struct ClearinghouseStateResponseAssetPositionsInnerPosition {
    /// The cryptocurrency or asset symbol.
    #[serde(rename = "coin", skip_serializing_if = "Option::is_none")]
    pub coin: Option<String>,
    #[serde(rename = "cumFunding", skip_serializing_if = "Option::is_none")]
    pub cum_funding: Option<Box<models::ClearinghouseStateResponseAssetPositionsInnerPositionCumFunding>>,
    /// The entry price for the position.
    #[serde(rename = "entryPx", skip_serializing_if = "Option::is_none")]
    pub entry_px: Option<String>,
    #[serde(rename = "leverage", skip_serializing_if = "Option::is_none")]
    pub leverage: Option<Box<models::ClearinghouseStateResponseAssetPositionsInnerPositionLeverage>>,
    /// The liquidation price for the position.
    #[serde(rename = "liquidationPx", skip_serializing_if = "Option::is_none")]
...
impl ClearinghouseStateResponseAssetPositionsInnerPosition {
    pub fn new() -> ClearinghouseStateResponseAssetPositionsInnerPosition {
