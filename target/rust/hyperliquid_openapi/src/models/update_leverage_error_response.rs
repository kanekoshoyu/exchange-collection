...
/// UpdateLeverageErrorResponse : ### Error Response Schema The response body for an error encountered during the update leverage request. 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateLeverageErrorResponse {
    /// Status indicating an error occurred.
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
    #[serde(rename = "response", skip_serializing_if = "Option::is_none")]
    pub response: Option<Box<models::UpdateLeverageErrorResponseResponse>>,
}

impl UpdateLeverageErrorResponse {
    /// ### Error Response Schema The response body for an error encountered during the update leverage request. 
    pub fn new() -> UpdateLeverageErrorResponse {
