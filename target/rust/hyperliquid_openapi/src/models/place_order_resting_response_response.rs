...
pub struct PlaceOrderRestingResponseResponse {
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<String>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::PlaceOrderRestingResponseResponseData>>,
}

impl PlaceOrderRestingResponseResponse {
    pub fn new() -> PlaceOrderRestingResponseResponse {
