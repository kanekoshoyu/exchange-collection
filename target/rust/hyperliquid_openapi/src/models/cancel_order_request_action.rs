...
/// CancelOrderRequestAction : The action object containing cancel order details.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CancelOrderRequestAction {
    /// Must be \"cancel\".
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<Type>,
    #[serde(rename = "cancels", skip_serializing_if = "Option::is_none")]
    pub cancels: Option<Vec<models::CancelOrderRequestActionCancelsInner>>,
}

impl CancelOrderRequestAction {
    /// The action object containing cancel order details.
    pub fn new() -> CancelOrderRequestAction {
