...
pub struct UpdateIsolatedMarginRequestAction {
    /// Must be \"updateIsolatedMargin\".
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<String>,
    /// Index of the coin for which margin is being updated.
    #[serde(rename = "asset", skip_serializing_if = "Option::is_none")]
    pub asset: Option<i32>,
    /// Currently has no effect until hedge mode is introduced.
    #[serde(rename = "isBuy", skip_serializing_if = "Option::is_none")]
    pub is_buy: Option<bool>,
    /// Amount of margin to add or remove.
    #[serde(rename = "ntli", skip_serializing_if = "Option::is_none")]
    pub ntli: Option<f32>,
}

impl UpdateIsolatedMarginRequestAction {
    pub fn new() -> UpdateIsolatedMarginRequestAction {
