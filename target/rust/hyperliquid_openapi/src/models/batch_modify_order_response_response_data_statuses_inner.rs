...
pub struct BatchModifyOrderResponseResponseDataStatusesInner {
    /// Order ID that was modified.
    #[serde(rename = "oid", skip_serializing_if = "Option::is_none")]
    pub oid: Option<i32>,
    /// Status of each order modification (e.g., \"modified\" or \"failed\").
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
}

impl BatchModifyOrderResponseResponseDataStatusesInner {
    pub fn new() -> BatchModifyOrderResponseResponseDataStatusesInner {
