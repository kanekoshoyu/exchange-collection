...
pub struct PlaceOrderRestingResponseResponseDataStatusesInnerResting {
    /// The order ID.
    #[serde(rename = "oid", skip_serializing_if = "Option::is_none")]
    pub oid: Option<i32>,
}

impl PlaceOrderRestingResponseResponseDataStatusesInnerResting {
    pub fn new() -> PlaceOrderRestingResponseResponseDataStatusesInnerResting {
