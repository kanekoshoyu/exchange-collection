...
/// ModifyOrderErrorResponse : ### Error Response Schema The response body for an error encountered during the modify order request. 
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ModifyOrderErrorResponse {
    /// Status indicating an error occurred.
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
    #[serde(rename = "response", skip_serializing_if = "Option::is_none")]
    pub response: Option<Box<models::ModifyOrderErrorResponseResponse>>,
}

impl ModifyOrderErrorResponse {
    /// ### Error Response Schema The response body for an error encountered during the modify order request. 
    pub fn new() -> ModifyOrderErrorResponse {
