...
pub struct ScheduleCancelResponseResponseData {
    /// Status of the scheduling (e.g., \"scheduled\" or \"canceled\").
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
}

impl ScheduleCancelResponseResponseData {
    pub fn new() -> ScheduleCancelResponseResponseData {
