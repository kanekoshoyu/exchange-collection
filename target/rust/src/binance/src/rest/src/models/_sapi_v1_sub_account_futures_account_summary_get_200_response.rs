...
pub struct SapiV1SubAccountFuturesAccountSummaryGet200Response {
    ...
    pub sub_account_list: Vec<models::SapiV1SubAccountFuturesAccountSummaryGet200ResponseSubAccountListInner>,
}

impl SapiV1SubAccountFuturesAccountSummaryGet200Response {
    pub fn new(total_initial_margin: String, total_maintenance_margin: String, total_margin_balance: String, total_open_order_initial_margin: String, total_position_initial_margin: String, total_unrealized_profit: String, total_wallet_balance: String, asset: String, sub_account_list: Vec<models::SapiV1SubAccountFuturesAccountSummaryGet200ResponseSubAccountListInner>) -> SapiV1SubAccountFuturesAccountSummaryGet200Response {
