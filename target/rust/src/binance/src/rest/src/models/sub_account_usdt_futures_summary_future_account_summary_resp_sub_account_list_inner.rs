...
pub struct SubAccountUsdtFuturesSummaryFutureAccountSummaryRespSubAccountListInner {
    #[serde(rename = "email")]
    pub email: String,
...
impl SubAccountUsdtFuturesSummaryFutureAccountSummaryRespSubAccountListInner {
