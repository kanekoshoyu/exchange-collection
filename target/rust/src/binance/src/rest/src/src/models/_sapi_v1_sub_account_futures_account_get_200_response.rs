...
pub struct SapiV1SubAccountFuturesAccountGet200Response {
    #[serde(rename = "email")]
    pub email: String,
    #[serde(rename = "asset")]
    pub asset: String,
