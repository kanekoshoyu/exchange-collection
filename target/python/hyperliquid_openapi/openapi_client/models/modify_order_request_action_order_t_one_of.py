...
class ModifyOrderRequestActionOrderTOneOf(BaseModel):
    """
    Limit order type with time-in-force options.
    """ # noqa: E501
    limit: Optional[ModifyOrderRequestActionOrderTOneOfLimit] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModifyOrderRequestActionOrderTOneOf from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModifyOrderRequestActionOrderTOneOf from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "limit": ModifyOrderRequestActionOrderTOneOfLimit.from_dict(obj["limit"]) if obj.get("limit") is not None else None
        })
        return _obj
