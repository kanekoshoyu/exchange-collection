...
class OrderSignedResponseRequestPayload(BaseModel):
    """
    OrderSignedResponseRequestPayload
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="Status of the request.")
    response: Optional[OrderSignedResponseRequestPayloadResponse] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderSignedResponseRequestPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderSignedResponseRequestPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "response": OrderSignedResponseRequestPayloadResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
