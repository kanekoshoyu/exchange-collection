...
class WsUserFill(BaseModel):
    """
    WsUserFill
    """ # noqa: E501
    coin: Optional[StrictStr] = None
    px: Optional[StrictStr] = None
    sz: Optional[StrictStr] = None
    side: Optional[StrictStr] = None
    time: Optional[Union[StrictFloat, StrictInt]] = None
    start_position: Optional[StrictStr] = Field(default=None, alias="startPosition")
    dir: Optional[StrictStr] = None
    closed_pnl: Optional[StrictStr] = Field(default=None, alias="closedPnl")
    hash: Optional[StrictStr] = None
    oid: Optional[Union[StrictFloat, StrictInt]] = None
    crossed: Optional[StrictBool] = None
    fee: Optional[StrictStr] = None
    tid: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["coin", "px", "sz", "side", "time", "startPosition", "dir", "closedPnl", "hash", "oid", "crossed", "fee", "tid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WsUserFill from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WsUserFill from a dict"""
        if obj is None:
            return None
