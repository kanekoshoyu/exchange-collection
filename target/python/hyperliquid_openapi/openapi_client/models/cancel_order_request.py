...
class CancelOrderRequest(BaseModel):
    """
    ### Request Schema The request body for canceling orders. You can specify one or more orders to cancel using their order IDs (oid). 
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "action": CancelOrderRequestAction.from_dict(obj["action"]) if obj.get("action") is not None else None,
            "nonce": obj.get("nonce"),
