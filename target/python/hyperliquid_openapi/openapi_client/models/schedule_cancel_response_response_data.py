...
class ScheduleCancelResponseResponseData(BaseModel):
    """
    ScheduleCancelResponseResponseData
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="Status of the scheduling (e.g., \"scheduled\" or \"canceled\").")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ScheduleCancelResponseResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ScheduleCancelResponseResponseData from a dict"""
        if obj is None:
            return None
