...
class Error(BaseModel):
    ...
    error_string: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["error_source", "error_type", "error_string"]
    ...
    def error_type_validate_enum(cls, value):
        ...
        if value not in set(['Tick', 'MinTradeNtl', 'Margin', 'ReduceOnly', 'BadAloPx', 'IocCancel', 'BadTriggerPx', 'MarketOrderNoLiquidity', 'MissingOrder']):
            raise ValueError("must be one of enum values ('Tick', 'MinTradeNtl', 'Margin', 'ReduceOnly', 'BadAloPx', 'IocCancel', 'BadTriggerPx', 'MarketOrderNoLiquidity', 'MissingOrder')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "error_string": obj.get("error_string")
        })
        return _obj
