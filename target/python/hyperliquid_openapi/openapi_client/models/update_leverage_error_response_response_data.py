...
class UpdateLeverageErrorResponseResponseData(BaseModel):
    """
    UpdateLeverageErrorResponseResponseData
    """ # noqa: E501
    error: Optional[StrictStr] = Field(default=None, description="Description of the error encountered during the update leverage request.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateLeverageErrorResponseResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateLeverageErrorResponseResponseData from a dict"""
        if obj is None:
            return None
