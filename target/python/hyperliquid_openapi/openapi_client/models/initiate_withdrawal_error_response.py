...
class InitiateWithdrawalErrorResponse(BaseModel):
    """
    ### Error Response Schema The response body for an error encountered during the withdrawal request. 
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="Status indicating an error occurred.")
    response: Optional[InitiateWithdrawalErrorResponseResponse] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InitiateWithdrawalErrorResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InitiateWithdrawalErrorResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "response": InitiateWithdrawalErrorResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
