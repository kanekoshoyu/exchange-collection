...
class OrderSignedResponseRequestPayloadResponseDataStatusesInner(BaseModel):
    """
    OrderSignedResponseRequestPayloadResponseDataStatusesInner
    """ # noqa: E501
    resting: Optional[OrderSignedResponseRequestPayloadResponseDataStatusesInnerResting] = None
    __properties: ClassVar[List[str]] = ["resting"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderSignedResponseRequestPayloadResponseDataStatusesInner from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of resting
        if self.resting:
            _dict['resting'] = self.resting.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderSignedResponseRequestPayloadResponseDataStatusesInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "resting": OrderSignedResponseRequestPayloadResponseDataStatusesInnerResting.from_dict(obj["resting"]) if obj.get("resting") is not None else None
        })
        return _obj
