...
class WebSocketPostResponseDataResponsePayloadData(BaseModel):
    """
    WebSocketPostResponseDataResponsePayloadData
    """ # noqa: E501
    coin: Optional[StrictStr] = Field(default=None, description="The cryptocurrency symbol.")
    time: Optional[StrictInt] = Field(default=None, description="The timestamp of the data.")
    levels: Optional[List[List[WsLevel]]] = Field(default=None, description="Order book levels for the coin.")
    __properties: ClassVar[List[str]] = ["coin", "time", "levels"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebSocketPostResponseDataResponsePayloadData from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in levels (list of list)
        _items = []
        if self.levels:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebSocketPostResponseDataResponsePayloadData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "time": obj.get("time"),
            "levels": [
                    [WsLevel.from_dict(_inner_item) for _inner_item in _item]
                    for _item in obj["levels"]
                ] if obj.get("levels") is not None else None
        })
        return _obj
