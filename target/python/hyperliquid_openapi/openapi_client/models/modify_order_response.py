...
class ModifyOrderResponse(BaseModel):
    """
    ### Response Schema The response body indicating the status of the modify order request. 
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="Status of the modify request.")
    response: Optional[ModifyOrderResponseResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "response": ModifyOrderResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
