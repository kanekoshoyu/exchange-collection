...
class OrderSignedResponse(BaseModel):
    """
    OrderSignedResponse
    """ # noqa: E501
    method: Optional[StrictStr] = Field(default=None, description="The method of the response.")
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the response.")
    request: Optional[OrderSignedResponseRequest] = None
    __properties: ClassVar[List[str]] = ["method", "id", "request"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderSignedResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderSignedResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "request": OrderSignedResponseRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
