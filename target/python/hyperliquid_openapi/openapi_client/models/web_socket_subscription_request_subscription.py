...
class WebSocketSubscriptionRequestSubscription(BaseModel):
    """
    WebSocketSubscriptionRequestSubscription
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="The type of subscription.")
    user: Optional[StrictStr] = Field(default=None, description="Address of the user. Optional based on subscription type.")
    coin: Optional[StrictStr] = Field(default=None, description="Coin symbol. Optional based on subscription type.")
    interval: Optional[StrictStr] = Field(default=None, description="Candle interval. Optional based on subscription type.")
    __properties: ClassVar[List[str]] = ["type", "user", "coin", "interval"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['allMids', 'notification', 'webData2', 'candle', 'l2Book', 'trades', 'orderUpdates', 'userEvents', 'userFills', 'userFundings', 'userNonFundingLedgerUpdates']):
            raise ValueError("must be one of enum values ('allMids', 'notification', 'webData2', 'candle', 'l2Book', 'trades', 'orderUpdates', 'userEvents', 'userFills', 'userFundings', 'userNonFundingLedgerUpdates')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebSocketSubscriptionRequestSubscription from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebSocketSubscriptionRequestSubscription from a dict"""
        if obj is None:
            return None
