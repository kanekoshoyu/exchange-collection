...
class MetaAndAssetCtxsRequest(BaseModel):
    """
    Retrieve perpetuals asset contexts (includes mark price, current funding, open interest, etc)
    """ # noqa: E501
    type: StrictStr = Field(description="Request type to retrieve metadata and asset contexts.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MetaAndAssetCtxsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MetaAndAssetCtxsRequest from a dict"""
        if obj is None:
            return None
