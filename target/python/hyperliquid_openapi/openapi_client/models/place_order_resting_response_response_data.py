...
class PlaceOrderRestingResponseResponseData(BaseModel):
    """
    PlaceOrderRestingResponseResponseData
    """ # noqa: E501
    statuses: Optional[List[PlaceOrderRestingResponseResponseDataStatusesInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlaceOrderRestingResponseResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlaceOrderRestingResponseResponseData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "statuses": [PlaceOrderRestingResponseResponseDataStatusesInner.from_dict(_item) for _item in obj["statuses"]] if obj.get("statuses") is not None else None
        })
        return _obj
