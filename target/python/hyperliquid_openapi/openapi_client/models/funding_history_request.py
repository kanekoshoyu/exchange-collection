...
class FundingHistoryRequest(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="The type of data to retrieve.")
    coin: StrictStr = Field(description="The cryptocurrency or asset symbol.")
    ...
    __properties: ClassVar[List[str]] = ["type", "coin", "startTime", "endTime"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['fundingHistory']):
            raise ValueError("must be one of enum values ('fundingHistory')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FundingHistoryRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FundingHistoryRequest from a dict"""
        if obj is None:
            return None
