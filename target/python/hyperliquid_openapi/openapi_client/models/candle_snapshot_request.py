...
class CandleSnapshotRequest(BaseModel):
    """
    Candle snapshot
    """ # noqa: E501
    type: StrictStr = Field(description="Request type to retrieve candle snapshots.")
    req: CandleSnapshotRequestReq
    __properties: ClassVar[List[str]] = ["type", "req"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CandleSnapshotRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CandleSnapshotRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "req": CandleSnapshotRequestReq.from_dict(obj["req"]) if obj.get("req") is not None else None
        })
        return _obj
