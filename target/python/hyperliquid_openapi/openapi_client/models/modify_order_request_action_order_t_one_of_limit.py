...
class ModifyOrderRequestActionOrderTOneOfLimit(BaseModel):
    """
    ModifyOrderRequestActionOrderTOneOfLimit
    """ # noqa: E501
    tif: Optional[StrictStr] = Field(default=None, description="Time-in-force options for limit orders.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModifyOrderRequestActionOrderTOneOfLimit from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModifyOrderRequestActionOrderTOneOfLimit from a dict"""
        if obj is None:
            return None
