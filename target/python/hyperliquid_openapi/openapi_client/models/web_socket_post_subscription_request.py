...
class WebSocketPostSubscriptionRequest(BaseModel):
    """
    WebSocketPostSubscriptionRequest
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="The type of request.")
    payload: Optional[WebSocketPostSubscriptionRequestPayload] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['info', 'action']):
            raise ValueError("must be one of enum values ('info', 'action')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebSocketPostSubscriptionRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebSocketPostSubscriptionRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "payload": WebSocketPostSubscriptionRequestPayload.from_dict(obj["payload"]) if obj.get("payload") is not None else None
        })
        return _obj
