...
class BatchModifyOrderResponse(BaseModel):
    """
    ### Response Schema The response body indicating the status of the batch modify order request. 
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="Status of the batch modify request.")
    response: Optional[BatchModifyOrderResponseResponse] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BatchModifyOrderResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BatchModifyOrderResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "response": BatchModifyOrderResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
