...
class L2BookResponseInnerInner(BaseModel):
    """
    L2BookResponseInnerInner
    """ # noqa: E501
    px: Optional[StrictStr] = Field(default=None, description="The price level.")
    sz: Optional[StrictStr] = Field(default=None, description="The size of the order at this price level.")
    n: Optional[StrictInt] = Field(default=None, description="The order rank or identifier.")
    __properties: ClassVar[List[str]] = ["px", "sz", "n"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of L2BookResponseInnerInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of L2BookResponseInnerInner from a dict"""
        if obj is None:
            return None
