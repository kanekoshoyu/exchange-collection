...
class OpenOrdersResponseInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["coin", "limitPx", "oid", "side", "sz", "timestamp"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OpenOrdersResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OpenOrdersResponseInner from a dict"""
        if obj is None:
            return None
