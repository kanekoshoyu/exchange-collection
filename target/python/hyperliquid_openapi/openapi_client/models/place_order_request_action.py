...
class PlaceOrderRequestAction(BaseModel):
    """
    The action object containing order details.
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Must be \"order\".")
    orders: Optional[List[PlaceOrderRequestActionOrdersInner]] = None
    grouping: Optional[StrictStr] = Field(default=None, description="Specifies the grouping type for the order.")
    ...
    def grouping_validate_enum(cls, value):
        ...
        if value not in set(['na', 'normalTpsl', 'positionTpsl']):
            raise ValueError("must be one of enum values ('na', 'normalTpsl', 'positionTpsl')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlaceOrderRequestAction from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlaceOrderRequestAction from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "orders": [PlaceOrderRequestActionOrdersInner.from_dict(_item) for _item in obj["orders"]] if obj.get("orders") is not None else None,
