...
class ClearinghouseStateRequest(BaseModel):
    """
    Retrieve user's perpetuals account summary
    """ # noqa: E501
    type: StrictStr = Field(description="The type of the request.")
    user: StrictStr = Field(description="Onchain address in 42-character hexadecimal format.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClearinghouseStateRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClearinghouseStateRequest from a dict"""
        if obj is None:
            return None
