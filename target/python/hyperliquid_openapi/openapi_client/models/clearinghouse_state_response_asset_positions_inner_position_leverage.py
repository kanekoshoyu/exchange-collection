...
class ClearinghouseStateResponseAssetPositionsInnerPositionLeverage(BaseModel):
    """
    Leverage details for the position.
    """ # noqa: E501
    raw_usd: Optional[StrictStr] = Field(default=None, description="The raw USD amount.", alias="rawUsd")
    type: Optional[StrictStr] = Field(default=None, description="The type of leverage, e.g., isolated or cross.")
    value: Optional[StrictInt] = Field(default=None, description="The leverage multiplier.")
    __properties: ClassVar[List[str]] = ["rawUsd", "type", "value"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClearinghouseStateResponseAssetPositionsInnerPositionLeverage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClearinghouseStateResponseAssetPositionsInnerPositionLeverage from a dict"""
        if obj is None:
            return None
