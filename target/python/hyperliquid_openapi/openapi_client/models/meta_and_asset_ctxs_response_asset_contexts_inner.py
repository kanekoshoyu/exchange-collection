...
class MetaAndAssetCtxsResponseAssetContextsInner(BaseModel):
    """
    MetaAndAssetCtxsResponseAssetContextsInner
    """ # noqa: E501
    day_ntl_vlm: Optional[StrictStr] = Field(default=None, description="The daily notional volume.", alias="dayNtlVlm")
    funding: Optional[StrictStr] = Field(default=None, description="The funding rate.")
    impact_pxs: Optional[List[StrictStr]] = Field(default=None, description="Impact prices for the asset.", alias="impactPxs")
    mark_px: Optional[StrictStr] = Field(default=None, description="The mark price of the asset.", alias="markPx")
    mid_px: Optional[StrictStr] = Field(default=None, description="The mid price of the asset.", alias="midPx")
    open_interest: Optional[StrictStr] = Field(default=None, description="The open interest for the asset.", alias="openInterest")
    oracle_px: Optional[StrictStr] = Field(default=None, description="The oracle price of the asset.", alias="oraclePx")
    premium: Optional[StrictStr] = Field(default=None, description="The premium of the asset.")
    prev_day_px: Optional[StrictStr] = Field(default=None, description="The previous day's price of the asset.", alias="prevDayPx")
    __properties: ClassVar[List[str]] = ["dayNtlVlm", "funding", "impactPxs", "markPx", "midPx", "openInterest", "oraclePx", "premium", "prevDayPx"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MetaAndAssetCtxsResponseAssetContextsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MetaAndAssetCtxsResponseAssetContextsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "dayNtlVlm": obj.get("dayNtlVlm"),
            "funding": obj.get("funding"),
            "impactPxs": obj.get("impactPxs"),
            "markPx": obj.get("markPx"),
            "midPx": obj.get("midPx"),
            "openInterest": obj.get("openInterest"),
            "oraclePx": obj.get("oraclePx"),
            "premium": obj.get("premium"),
            "prevDayPx": obj.get("prevDayPx")
        })
        return _obj
