...
class WebSocketPostResponse(BaseModel):
    """
    WebSocketPostResponse
    """ # noqa: E501
    channel: Optional[StrictStr] = Field(default=None, description="The communication channel of the response.")
    data: Optional[WebSocketPostResponseData] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebSocketPostResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebSocketPostResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": WebSocketPostResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
