...
class CancelOrderRequestAction(BaseModel):
    """
    The action object containing cancel order details.
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Must be \"cancel\".")
    cancels: Optional[List[CancelOrderRequestActionCancelsInner]] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['cancel']):
            raise ValueError("must be one of enum values ('cancel')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CancelOrderRequestAction from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CancelOrderRequestAction from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "cancels": [CancelOrderRequestActionCancelsInner.from_dict(_item) for _item in obj["cancels"]] if obj.get("cancels") is not None else None
        })
        return _obj
