...
class BatchModifyOrderRequestAction(BaseModel):
    """
    BatchModifyOrderRequestAction
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Must be \"batchModify\".")
    modifies: Optional[List[BatchModifyOrderRequestActionModifiesInner]] = None
    __properties: ClassVar[List[str]] = ["type", "modifies"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BatchModifyOrderRequestAction from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in modifies (list)
        _items = []
        if self.modifies:
            for _item in self.modifies:
                if _item:
                    _items.append(_item.to_dict())
            _dict['modifies'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BatchModifyOrderRequestAction from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "modifies": [BatchModifyOrderRequestActionModifiesInner.from_dict(_item) for _item in obj["modifies"]] if obj.get("modifies") is not None else None
        })
        return _obj
