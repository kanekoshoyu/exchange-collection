...
class PlaceOrderRequestActionOrdersInner(BaseModel):
    """
    PlaceOrderRequestActionOrdersInner
    """ # noqa: E501
    a: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The asset.")
    b: Optional[StrictBool] = Field(default=None, description="Indicates if the order is a buy order.")
    p: Optional[StrictStr] = Field(default=None, description="The price at which to place the order.")
    s: Optional[StrictStr] = Field(default=None, description="The size of the order.")
    r: Optional[StrictBool] = Field(default=None, description="Indicates if the order is reduce-only.")
    t: Optional[PlaceOrderRequestActionOrdersInnerT] = None
    c: Optional[StrictStr] = Field(default=None, description="Optional client order ID (cloid), a 128-bit hex string. Example: 0x1234567890abcdef1234567890abcdef. ")
    __properties: ClassVar[List[str]] = ["a", "b", "p", "s", "r", "t", "c"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlaceOrderRequestActionOrdersInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlaceOrderRequestActionOrdersInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "s": obj.get("s"),
            "r": obj.get("r"),
            "t": PlaceOrderRequestActionOrdersInnerT.from_dict(obj["t"]) if obj.get("t") is not None else None,
            "c": obj.get("c")
        })
        return _obj
