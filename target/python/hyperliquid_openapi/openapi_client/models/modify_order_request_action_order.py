...
class ModifyOrderRequestActionOrder(BaseModel):
    """
    ModifyOrderRequestActionOrder
    """ # noqa: E501
    a: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Asset identifier.")
    b: Optional[StrictBool] = Field(default=None, description="Whether the order is a buy order.")
    p: Optional[StrictStr] = Field(default=None, description="Price at which to place the order.")
    s: Optional[StrictStr] = Field(default=None, description="Size of the order.")
    r: Optional[StrictBool] = Field(default=None, description="Whether the order is reduce-only.")
    t: Optional[ModifyOrderRequestActionOrderT] = None
    c: Optional[StrictStr] = Field(default=None, description="Client order ID (optional).")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModifyOrderRequestActionOrder from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModifyOrderRequestActionOrder from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "s": obj.get("s"),
            "r": obj.get("r"),
            "t": ModifyOrderRequestActionOrderT.from_dict(obj["t"]) if obj.get("t") is not None else None,
            "c": obj.get("c")
        })
        return _obj
