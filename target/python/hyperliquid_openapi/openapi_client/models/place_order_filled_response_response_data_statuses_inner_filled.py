...
class PlaceOrderFilledResponseResponseDataStatusesInnerFilled(BaseModel):
    """
    PlaceOrderFilledResponseResponseDataStatusesInnerFilled
    """ # noqa: E501
    oid: Optional[StrictInt] = Field(default=None, description="The order ID.")
    total_sz: Optional[StrictInt] = Field(default=None, alias="totalSz")
    avg_px: Optional[StrictInt] = Field(default=None, alias="avgPx")
    __properties: ClassVar[List[str]] = ["oid", "totalSz", "avgPx"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlaceOrderFilledResponseResponseDataStatusesInnerFilled from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlaceOrderFilledResponseResponseDataStatusesInnerFilled from a dict"""
        if obj is None:
            return None
