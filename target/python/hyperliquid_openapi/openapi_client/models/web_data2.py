...
class WebData2(BaseModel):
    """
    WebData2
    """ # noqa: E501
    example_property1: Optional[StrictStr] = Field(default=None, alias="exampleProperty1")
    example_property2: Optional[StrictInt] = Field(default=None, alias="exampleProperty2")
    __properties: ClassVar[List[str]] = ["exampleProperty1", "exampleProperty2"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebData2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebData2 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "exampleProperty1": obj.get("exampleProperty1"),
            "exampleProperty2": obj.get("exampleProperty2")
        })
        return _obj
