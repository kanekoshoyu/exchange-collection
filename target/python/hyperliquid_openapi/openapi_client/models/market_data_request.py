...
class MarketDataRequest(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="The type of market data to retrieve.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MarketDataRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MarketDataRequest from a dict"""
        if obj is None:
            return None
