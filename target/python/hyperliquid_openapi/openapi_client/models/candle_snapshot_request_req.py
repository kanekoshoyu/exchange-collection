...
class CandleSnapshotRequestReq(BaseModel):
    """
    CandleSnapshotRequestReq
    """ # noqa: E501
    coin: StrictStr = Field(description="The cryptocurrency coin for which to retrieve candle data.")
    interval: StrictStr = Field(description="The time interval for the candles (e.g., \"15m\").")
    start_time: StrictInt = Field(description="Start time in epoch milliseconds.", alias="startTime")
    end_time: StrictInt = Field(description="End time in epoch milliseconds.", alias="endTime")
    __properties: ClassVar[List[str]] = ["coin", "interval", "startTime", "endTime"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CandleSnapshotRequestReq from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CandleSnapshotRequestReq from a dict"""
        if obj is None:
            return None
