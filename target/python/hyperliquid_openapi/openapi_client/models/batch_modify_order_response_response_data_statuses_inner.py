...
class BatchModifyOrderResponseResponseDataStatusesInner(BaseModel):
    """
    BatchModifyOrderResponseResponseDataStatusesInner
    """ # noqa: E501
    oid: Optional[StrictInt] = Field(default=None, description="Order ID that was modified.")
    status: Optional[StrictStr] = Field(default=None, description="Status of each order modification (e.g., \"modified\" or \"failed\").")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BatchModifyOrderResponseResponseDataStatusesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BatchModifyOrderResponseResponseDataStatusesInner from a dict"""
        if obj is None:
            return None
