...
class OrderSignedRequestRequestPayloadActionOrdersInnerTLimit(BaseModel):
    """
    OrderSignedRequestRequestPayloadActionOrdersInnerTLimit
    """ # noqa: E501
    tif: Optional[StrictStr] = Field(default=None, description="Time in force for the order.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderSignedRequestRequestPayloadActionOrdersInnerTLimit from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderSignedRequestRequestPayloadActionOrdersInnerTLimit from a dict"""
        if obj is None:
            return None
