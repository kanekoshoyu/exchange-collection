...
class WebSocketPostResponseDataResponsePayload(BaseModel):
    """
    WebSocketPostResponseDataResponsePayload
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Type of data contained in the payload.")
    data: Optional[WebSocketPostResponseDataResponsePayloadData] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebSocketPostResponseDataResponsePayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebSocketPostResponseDataResponsePayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "data": WebSocketPostResponseDataResponsePayloadData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
