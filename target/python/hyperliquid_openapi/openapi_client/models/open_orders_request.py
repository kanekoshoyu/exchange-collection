...
class OpenOrdersRequest(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="Request type to see open orders.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OpenOrdersRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OpenOrdersRequest from a dict"""
        if obj is None:
            return None
