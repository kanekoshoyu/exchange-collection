...
class UpdateIsolatedMarginRequestAction(BaseModel):
    """
    UpdateIsolatedMarginRequestAction
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Must be \"updateIsolatedMargin\".")
    asset: Optional[StrictInt] = Field(default=None, description="Index of the coin for which margin is being updated.")
    is_buy: Optional[StrictBool] = Field(default=None, description="Currently has no effect until hedge mode is introduced.", alias="isBuy")
    ntli: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Amount of margin to add or remove.")
    __properties: ClassVar[List[str]] = ["type", "asset", "isBuy", "ntli"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateIsolatedMarginRequestAction from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateIsolatedMarginRequestAction from a dict"""
        if obj is None:
            return None
