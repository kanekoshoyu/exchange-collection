...
class ModifyOrderRequestAction(BaseModel):
    """
    ModifyOrderRequestAction
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Must be \"modify\".")
    oid: Optional[StrictInt] = Field(default=None, description="Order ID to modify.")
    order: Optional[ModifyOrderRequestActionOrder] = None
    __properties: ClassVar[List[str]] = ["type", "oid", "order"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModifyOrderRequestAction from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModifyOrderRequestAction from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "oid": obj.get("oid"),
            "order": ModifyOrderRequestActionOrder.from_dict(obj["order"]) if obj.get("order") is not None else None
        })
        return _obj
