...
class ClearinghouseStateResponseAssetPositionsInner(BaseModel):
    """
    ClearinghouseStateResponseAssetPositionsInner
    """ # noqa: E501
    position: Optional[ClearinghouseStateResponseAssetPositionsInnerPosition] = None
    type: Optional[StrictStr] = Field(default=None, description="The type of position, e.g., one-way or hedge.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClearinghouseStateResponseAssetPositionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClearinghouseStateResponseAssetPositionsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "position": ClearinghouseStateResponseAssetPositionsInnerPosition.from_dict(obj["position"]) if obj.get("position") is not None else None,
            "type": obj.get("type")
        })
        return _obj
