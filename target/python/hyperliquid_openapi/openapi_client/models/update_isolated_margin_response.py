...
class UpdateIsolatedMarginResponse(BaseModel):
    """
    ### Successful Response Schema The response body indicating the status of the update isolated margin request. 
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="Status of the update isolated margin request.")
    response: Optional[UpdateLeverageResponseResponse] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateIsolatedMarginResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateIsolatedMarginResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "response": UpdateLeverageResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
