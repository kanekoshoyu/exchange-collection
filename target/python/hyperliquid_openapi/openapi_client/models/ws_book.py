...
class WsBook(BaseModel):
    """
    WsBook
    """ # noqa: E501
    coin: Optional[StrictStr] = None
    levels: Optional[List[List[WsLevel]]] = None
    time: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["coin", "levels", "time"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WsBook from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WsBook from a dict"""
        if obj is None:
            return None
