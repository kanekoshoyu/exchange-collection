...
class MetaResponseUniverseInner(BaseModel):
    """
    MetaResponseUniverseInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name of the asset or universe.")
    sz_decimals: Optional[StrictInt] = Field(default=None, description="The number of decimal places for sizes.", alias="szDecimals")
    max_leverage: Optional[StrictInt] = Field(default=None, description="The maximum leverage allowed for the asset.", alias="maxLeverage")
    only_isolated: Optional[StrictBool] = Field(default=None, description="Indicates if only isolated margin is allowed.", alias="onlyIsolated")
    __properties: ClassVar[List[str]] = ["name", "szDecimals", "maxLeverage", "onlyIsolated"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MetaResponseUniverseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MetaResponseUniverseInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "onlyIsolated": obj.get("onlyIsolated")
        })
        return _obj
