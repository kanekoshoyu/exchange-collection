...
class SpotMetaAndAssetCtxsResponseInnerOneOf(BaseModel):
    """
    SpotMetaAndAssetCtxsResponseInnerOneOf
    """ # noqa: E501
    tokens: Optional[List[SpotMetaResponseTokensInner]] = None
    universe: Optional[List[SpotMetaResponseUniverseInner]] = None
    __properties: ClassVar[List[str]] = ["tokens", "universe"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SpotMetaAndAssetCtxsResponseInnerOneOf from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SpotMetaAndAssetCtxsResponseInnerOneOf from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "tokens": [SpotMetaResponseTokensInner.from_dict(_item) for _item in obj["tokens"]] if obj.get("tokens") is not None else None,
            "universe": [SpotMetaResponseUniverseInner.from_dict(_item) for _item in obj["universe"]] if obj.get("universe") is not None else None
        })
        return _obj
