...
class UpdateLeverageRequest(BaseModel):
    """
    ### Request Schema The request body for updating cross or isolated leverage on a coin. 
    """ # noqa: E501
    action: UpdateLeverageRequestAction
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateLeverageRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateLeverageRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "action": UpdateLeverageRequestAction.from_dict(obj["action"]) if obj.get("action") is not None else None,
            "nonce": obj.get("nonce"),
