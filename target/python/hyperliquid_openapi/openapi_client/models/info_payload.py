...
class InfoPayload(BaseModel):
    ...
    InfoPayload
    """ # noqa: E501
    detail: Optional[StrictStr] = Field(default=None, description="Detailed information related to the request.")
    timestamp: Optional[datetime] = Field(default=None, description="The timestamp of the info event.")
    __properties: ClassVar[List[str]] = ["detail", "timestamp"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InfoPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InfoPayload from a dict"""
        if obj is None:
            return None
