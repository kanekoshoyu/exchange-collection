...
class UpdateIsolatedMarginRequest(BaseModel):
    """
    ### Request Schema The request body for adding or removing margin from an isolated position. 
    """ # noqa: E501
    action: UpdateIsolatedMarginRequestAction
    nonce: StrictInt = Field(description="Recommended to use the current timestamp in milliseconds.")
    signature: ModifyOrderRequestSignature
    __properties: ClassVar[List[str]] = ["action", "nonce", "signature"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateIsolatedMarginRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateIsolatedMarginRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "action": UpdateIsolatedMarginRequestAction.from_dict(obj["action"]) if obj.get("action") is not None else None,
            "nonce": obj.get("nonce"),
            "signature": ModifyOrderRequestSignature.from_dict(obj["signature"]) if obj.get("signature") is not None else None
        })
        return _obj
