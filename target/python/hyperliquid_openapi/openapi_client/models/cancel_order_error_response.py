...
class CancelOrderErrorResponse(BaseModel):
    """
    Response when there is an error in canceling the order(s).
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CancelOrderErrorResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CancelOrderErrorResponse from a dict"""
        if obj is None:
            return None
