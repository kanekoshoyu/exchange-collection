...
class WebSocketPostResponseDataResponse(BaseModel):
    """
    WebSocketPostResponseDataResponse
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Type of response data.")
    payload: Optional[WebSocketPostResponseDataResponsePayload] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebSocketPostResponseDataResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebSocketPostResponseDataResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "payload": WebSocketPostResponseDataResponsePayload.from_dict(obj["payload"]) if obj.get("payload") is not None else None
        })
        return _obj
