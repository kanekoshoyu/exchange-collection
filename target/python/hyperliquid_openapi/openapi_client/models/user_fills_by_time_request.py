...
class UserFillsByTimeRequest(BaseModel):
    """
    Retrieve a user's fills by time
    """ # noqa: E501
    type: StrictStr = Field(description="Request type to retrieve user fills by time.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserFillsByTimeRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserFillsByTimeRequest from a dict"""
        if obj is None:
            return None
