...
class AllMids(BaseModel):
    """
    AllMids
    """ # noqa: E501
    mids: Optional[Dict[str, StrictStr]] = None
    __properties: ClassVar[List[str]] = ["mids"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AllMids from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AllMids from a dict"""
        if obj is None:
            return None
