...
class VaultTransferRequest(BaseModel):
    """
    ### Request Schema The request body for depositing into or withdrawing from a vault. The `isDeposit` flag indicates whether the operation is a deposit or a withdrawal. 
    """ # noqa: E501
    action: VaultTransferRequestAction
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VaultTransferRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VaultTransferRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "action": VaultTransferRequestAction.from_dict(obj["action"]) if obj.get("action") is not None else None,
            "nonce": obj.get("nonce"),
