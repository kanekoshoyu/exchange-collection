...
class ModifyOrderResponseResponseData(BaseModel):
    """
    ModifyOrderResponseResponseData
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="Status of the order modification (e.g., \"modified\" or \"failed\").")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModifyOrderResponseResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModifyOrderResponseResponseData from a dict"""
        if obj is None:
            return None
