...
class BatchModifyOrderRequest(BaseModel):
    """
    ### Request Schema The request body for modifying multiple existing orders. 
    """ # noqa: E501
    action: BatchModifyOrderRequestAction
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BatchModifyOrderRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BatchModifyOrderRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "action": BatchModifyOrderRequestAction.from_dict(obj["action"]) if obj.get("action") is not None else None,
            "nonce": obj.get("nonce"),
