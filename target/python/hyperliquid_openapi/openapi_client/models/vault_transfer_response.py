...
class VaultTransferResponse(BaseModel):
    """
    ### Successful Response Schema The response body indicating the status of the vault transfer request. 
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="Status of the vault transfer request.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VaultTransferResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VaultTransferResponse from a dict"""
        if obj is None:
            return None
