...
class WebSocketMessageSubscription(BaseModel):
    """
    WebSocketMessageSubscription
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="The type of data subscription (e.g., \"trades\", \"orderBook\").")
    coin: Optional[StrictStr] = Field(default=None, description="The cryptocurrency for which data is being subscribed (e.g., \"SOL\").")
    __properties: ClassVar[List[str]] = ["type", "coin"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebSocketMessageSubscription from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebSocketMessageSubscription from a dict"""
        if obj is None:
            return None
