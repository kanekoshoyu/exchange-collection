...
class UpdateLeverageResponseResponse(BaseModel):
    """
    UpdateLeverageResponseResponse
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Indicates the response type for a successful operation.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateLeverageResponseResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateLeverageResponseResponse from a dict"""
        if obj is None:
            return None
