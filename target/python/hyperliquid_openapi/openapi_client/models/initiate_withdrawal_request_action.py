...
class InitiateWithdrawalRequestAction(BaseModel):
    """
    InitiateWithdrawalRequestAction
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Must be \"withdraw3\".")
    ...
    amount: Optional[StrictStr] = Field(default=None, description="The amount of USD to withdraw as a string.")
    time: Optional[StrictInt] = Field(default=None, description="Current timestamp in milliseconds as a number, should match nonce.")
    destination: Optional[StrictStr] = Field(default=None, description="The address to withdraw to in 42-character hexadecimal format.")
    __properties: ClassVar[List[str]] = ["type", "hyperliquidChain", "signatureChainId", "amount", "time", "destination"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InitiateWithdrawalRequestAction from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InitiateWithdrawalRequestAction from a dict"""
        if obj is None:
            return None
