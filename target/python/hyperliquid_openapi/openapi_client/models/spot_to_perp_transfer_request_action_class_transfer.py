...
class SpotToPerpTransferRequestActionClassTransfer(BaseModel):
    """
    SpotToPerpTransferRequestActionClassTransfer
    """ # noqa: E501
    usdc: Optional[StrictInt] = Field(default=None, description="The amount of raw USDC to send, represented as an integer (e.g., for 1 USDC, use 1e6).")
    to_perp: Optional[StrictBool] = Field(default=None, description="If true, transfer from spot to perp wallet; if false, transfer from perp to spot wallet.", alias="toPerp")
    __properties: ClassVar[List[str]] = ["usdc", "toPerp"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SpotToPerpTransferRequestActionClassTransfer from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SpotToPerpTransferRequestActionClassTransfer from a dict"""
        if obj is None:
            return None
