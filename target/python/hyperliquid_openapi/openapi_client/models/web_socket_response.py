...
class WebSocketResponse(BaseModel):
    ...
    WebSocketResponse
    """ # noqa: E501
    channel: StrictStr = Field(description="The channel of the response (e.g., \"subscriptionResponse\").")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebSocketResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebSocketResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": WebSocketResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
