...
class PlaceOrderRequestActionOrdersInnerTTrigger(BaseModel):
    """
    Trigger order details.
    """ # noqa: E501
    is_market: Optional[StrictBool] = Field(default=None, description="Indicates if the trigger order is a market order.", alias="isMarket")
    trigger_px: Optional[StrictStr] = Field(default=None, description="The price at which the order is triggered.", alias="triggerPx")
    tpsl: Optional[StrictStr] = Field(default=None, description="Indicates if the order is a take profit (tp) or stop loss (sl).")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlaceOrderRequestActionOrdersInnerTTrigger from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlaceOrderRequestActionOrdersInnerTTrigger from a dict"""
        if obj is None:
            return None
