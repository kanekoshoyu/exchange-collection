...
class WsOrder(BaseModel):
    ...
    WsOrder
    """ # noqa: E501
    order: Optional[WsBasicOrder] = None
    status: Optional[StrictStr] = Field(default=None, description="Possible values open, filled, canceled, triggered, rejected, marginCanceled")
    status_timestamp: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="statusTimestamp")
    __properties: ClassVar[List[str]] = ["order", "status", "statusTimestamp"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WsOrder from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WsOrder from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "order": WsBasicOrder.from_dict(obj["order"]) if obj.get("order") is not None else None,
