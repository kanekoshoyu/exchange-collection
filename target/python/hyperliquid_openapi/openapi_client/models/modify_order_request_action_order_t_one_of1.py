...
class ModifyOrderRequestActionOrderTOneOf1(BaseModel):
    """
    Trigger order type with market option.
    """ # noqa: E501
    trigger: Optional[ModifyOrderRequestActionOrderTOneOf1Trigger] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModifyOrderRequestActionOrderTOneOf1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModifyOrderRequestActionOrderTOneOf1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "trigger": ModifyOrderRequestActionOrderTOneOf1Trigger.from_dict(obj["trigger"]) if obj.get("trigger") is not None else None
        })
        return _obj
