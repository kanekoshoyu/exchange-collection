...
class OrderSignedRequestRequestPayloadActionOrdersInner(BaseModel):
    """
    OrderSignedRequestRequestPayloadActionOrdersInner
    """ # noqa: E501
    a: Optional[StrictInt] = Field(default=None, description="Order attribute 'a'.")
    b: Optional[StrictBool] = Field(default=None, description="Order attribute 'b'.")
    p: Optional[StrictStr] = Field(default=None, description="Price of the order.")
    s: Optional[StrictStr] = Field(default=None, description="Size of the order.")
    r: Optional[StrictBool] = Field(default=None, description="Order attribute 'r'.")
    t: Optional[OrderSignedRequestRequestPayloadActionOrdersInnerT] = None
    __properties: ClassVar[List[str]] = ["a", "b", "p", "s", "r", "t"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderSignedRequestRequestPayloadActionOrdersInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderSignedRequestRequestPayloadActionOrdersInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "s": obj.get("s"),
            "r": obj.get("r"),
            "t": OrderSignedRequestRequestPayloadActionOrdersInnerT.from_dict(obj["t"]) if obj.get("t") is not None else None
        })
        return _obj
