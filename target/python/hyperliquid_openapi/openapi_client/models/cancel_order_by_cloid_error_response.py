...
class CancelOrderByCloidErrorResponse(BaseModel):
    """
    Response when there is an error in canceling the order(s) by cloid.
    """ # noqa: E501
    status: Optional[StrictStr] = None
    response: Optional[PlaceOrderErrorResponseResponse] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CancelOrderByCloidErrorResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CancelOrderByCloidErrorResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "response": PlaceOrderErrorResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
