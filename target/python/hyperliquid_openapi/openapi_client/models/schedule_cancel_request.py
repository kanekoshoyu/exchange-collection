...
class ScheduleCancelRequest(BaseModel):
    """
    ### Request Schema The request body for scheduling a cancel-all operation. Setting `time` to `null` will remove any outstanding scheduled cancel operation. 
    """ # noqa: E501
    type: StrictStr = Field(description="Must be \"scheduleCancel\".")
    time: Optional[StrictInt] = Field(description="The time (in Unix milliseconds) at which the cancel-all operation should occur. Setting this to `null` will remove any outstanding scheduled cancel operation. ")
    __properties: ClassVar[List[str]] = ["type", "time"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ScheduleCancelRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ScheduleCancelRequest from a dict"""
        if obj is None:
            return None
