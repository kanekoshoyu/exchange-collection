...
class ActionPayloadParameters(BaseModel):
    """
    Parameters for the action.
    """ # noqa: E501
    param1: Optional[StrictStr] = Field(default=None, description="A parameter for the action.")
    param2: Optional[StrictInt] = Field(default=None, description="Another parameter for the action.")
    __properties: ClassVar[List[str]] = ["param1", "param2"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ActionPayloadParameters from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ActionPayloadParameters from a dict"""
        if obj is None:
            return None
