...
class OrderSignedResponseRequestPayloadResponseDataStatusesInnerResting(BaseModel):
    """
    OrderSignedResponseRequestPayloadResponseDataStatusesInnerResting
    """ # noqa: E501
    oid: Optional[StrictInt] = Field(default=None, description="Order ID.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderSignedResponseRequestPayloadResponseDataStatusesInnerResting from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderSignedResponseRequestPayloadResponseDataStatusesInnerResting from a dict"""
        if obj is None:
            return None
