...
class ModifyOrderRequest(BaseModel):
    """
    ### Request Schema The request body for modifying an existing order. 
    """ # noqa: E501
    action: ModifyOrderRequestAction
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "action": ModifyOrderRequestAction.from_dict(obj["action"]) if obj.get("action") is not None else None,
            "nonce": obj.get("nonce"),
