...
class PlaceOrderRestingResponse(BaseModel):
    """
    Response when the order is placed and resting.
    """ # noqa: E501
    status: Optional[StrictStr] = None
    response: Optional[PlaceOrderRestingResponseResponse] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlaceOrderRestingResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlaceOrderRestingResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "response": PlaceOrderRestingResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
