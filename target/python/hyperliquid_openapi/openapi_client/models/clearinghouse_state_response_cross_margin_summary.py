...
class ClearinghouseStateResponseCrossMarginSummary(BaseModel):
    """
    Summary of the cross margin account.
    """ # noqa: E501
    account_value: Optional[StrictStr] = Field(default=None, description="The total account value.", alias="accountValue")
    total_margin_used: Optional[StrictStr] = Field(default=None, description="The total margin used.", alias="totalMarginUsed")
    total_ntl_pos: Optional[StrictStr] = Field(default=None, description="The total notional position.", alias="totalNtlPos")
    total_raw_usd: Optional[StrictStr] = Field(default=None, description="The total raw USD value.", alias="totalRawUsd")
    __properties: ClassVar[List[str]] = ["accountValue", "totalMarginUsed", "totalNtlPos", "totalRawUsd"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClearinghouseStateResponseCrossMarginSummary from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClearinghouseStateResponseCrossMarginSummary from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "totalMarginUsed": obj.get("totalMarginUsed"),
            "totalNtlPos": obj.get("totalNtlPos"),
            "totalRawUsd": obj.get("totalRawUsd")
        })
        return _obj
