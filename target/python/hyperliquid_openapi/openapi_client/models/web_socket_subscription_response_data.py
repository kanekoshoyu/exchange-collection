...
class WebSocketSubscriptionResponseData(BaseModel):
    """
    WebSocketSubscriptionResponseData
    """ # noqa: E501
    method: Optional[StrictStr] = None
    subscription: Optional[WebSocketSubscriptionRequestSubscription] = None
    response_data: Optional[WebSocketSubscriptionResponseDataResponseData] = Field(default=None, alias="responseData")
    __properties: ClassVar[List[str]] = ["method", "subscription", "responseData"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebSocketSubscriptionResponseData from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.response_data:
            _dict['responseData'] = self.response_data.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebSocketSubscriptionResponseData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "subscription": WebSocketSubscriptionRequestSubscription.from_dict(obj["subscription"]) if obj.get("subscription") is not None else None,
            "responseData": WebSocketSubscriptionResponseDataResponseData.from_dict(obj["responseData"]) if obj.get("responseData") is not None else None
        })
        return _obj
