...
class ClearinghouseStateResponseAssetPositionsInnerPositionCumFunding(BaseModel):
    """
    Cumulative funding details.
    """ # noqa: E501
    all_time: Optional[StrictStr] = Field(default=None, description="All-time cumulative funding.", alias="allTime")
    since_change: Optional[StrictStr] = Field(default=None, description="Cumulative funding since the last change.", alias="sinceChange")
    since_open: Optional[StrictStr] = Field(default=None, description="Cumulative funding since the position was opened.", alias="sinceOpen")
    __properties: ClassVar[List[str]] = ["allTime", "sinceChange", "sinceOpen"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClearinghouseStateResponseAssetPositionsInnerPositionCumFunding from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClearinghouseStateResponseAssetPositionsInnerPositionCumFunding from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "allTime": obj.get("allTime"),
            "sinceChange": obj.get("sinceChange"),
            "sinceOpen": obj.get("sinceOpen")
        })
        return _obj
