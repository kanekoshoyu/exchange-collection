...
class PlaceOrderFilledResponseResponseDataStatusesInner(BaseModel):
    """
    PlaceOrderFilledResponseResponseDataStatusesInner
    """ # noqa: E501
    filled: Optional[PlaceOrderFilledResponseResponseDataStatusesInnerFilled] = None
    __properties: ClassVar[List[str]] = ["filled"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlaceOrderFilledResponseResponseDataStatusesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlaceOrderFilledResponseResponseDataStatusesInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "filled": PlaceOrderFilledResponseResponseDataStatusesInnerFilled.from_dict(obj["filled"]) if obj.get("filled") is not None else None
        })
        return _obj
