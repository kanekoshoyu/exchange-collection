...
class OrderSignedRequestRequestPayload(BaseModel):
    """
    OrderSignedRequestRequestPayload
    """ # noqa: E501
    action: Optional[OrderSignedRequestRequestPayloadAction] = None
    nonce: Optional[StrictInt] = Field(default=None, description="Nonce value for the request.")
    signature: Optional[OrderSignedRequestRequestPayloadSignature] = None
    vault_address: Optional[StrictStr] = Field(default=None, description="The vault address in hexadecimal format.", alias="vaultAddress")
    __properties: ClassVar[List[str]] = ["action", "nonce", "signature", "vaultAddress"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderSignedRequestRequestPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderSignedRequestRequestPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "action": OrderSignedRequestRequestPayloadAction.from_dict(obj["action"]) if obj.get("action") is not None else None,
            "nonce": obj.get("nonce"),
            "signature": OrderSignedRequestRequestPayloadSignature.from_dict(obj["signature"]) if obj.get("signature") is not None else None,
            "vaultAddress": obj.get("vaultAddress")
        })
        return _obj
