...
class ActionPayload(BaseModel):
    ...
    ActionPayload
    """ # noqa: E501
    action_type: Optional[StrictStr] = Field(default=None, description="The specific action to be performed.", alias="actionType")
    parameters: Optional[ActionPayloadParameters] = None
    __properties: ClassVar[List[str]] = ["actionType", "parameters"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ActionPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ActionPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "parameters": ActionPayloadParameters.from_dict(obj["parameters"]) if obj.get("parameters") is not None else None
        })
        return _obj
