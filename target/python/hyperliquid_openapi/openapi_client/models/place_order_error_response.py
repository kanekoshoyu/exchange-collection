...
class PlaceOrderErrorResponse(BaseModel):
    """
    Response when there is an error in order placement.
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlaceOrderErrorResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlaceOrderErrorResponse from a dict"""
        if obj is None:
            return None
