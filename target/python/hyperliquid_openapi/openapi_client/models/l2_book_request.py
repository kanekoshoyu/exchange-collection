...
class L2BookRequest(BaseModel):
    """
    L2 Book snapshot
    """ # noqa: E501
    type: StrictStr = Field(description="Request type to retrieve the level 2 order book.")
    coin: StrictStr = Field(description="The cryptocurrency coin for which to retrieve the order book.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of L2BookRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of L2BookRequest from a dict"""
        if obj is None:
            return None
