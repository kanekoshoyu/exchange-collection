...
class L1SpotTransferRequestAction(BaseModel):
    """
    L1SpotTransferRequestAction
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Must be \"spotSend\".")
    hyperliquid_chain: Optional[StrictStr] = Field(default=None, description="The Hyperliquid chain to use, set to \"Mainnet\" or \"Testnet\".", alias="hyperliquidChain")
    signature_chain_id: Optional[StrictStr] = Field(default=None, description="The ID of the chain used when signing in hexadecimal format (e.g., \"0xa4b1\" for Arbitrum).", alias="signatureChainId")
    destination: Optional[StrictStr] = Field(default=None, description="The address to send spot assets to in 42-character hexadecimal format.")
    token: Optional[StrictStr] = Field(default=None, description="The token name and ID, formatted as \"tokenName:tokenId\".")
    amount: Optional[StrictStr] = Field(default=None, description="The amount of the token to send as a string.")
    time: Optional[StrictInt] = Field(default=None, description="Current timestamp in milliseconds as a number, should match nonce.")
    __properties: ClassVar[List[str]] = ["type", "hyperliquidChain", "signatureChainId", "destination", "token", "amount", "time"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of L1SpotTransferRequestAction from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of L1SpotTransferRequestAction from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "hyperliquidChain": obj.get("hyperliquidChain"),
            "signatureChainId": obj.get("signatureChainId"),
