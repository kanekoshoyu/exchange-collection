...
class CancelOrderByCloidRequestActionCancelsInner(BaseModel):
    """
    CancelOrderByCloidRequestActionCancelsInner
    """ # noqa: E501
    asset: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The asset associated with the order.")
    cloid: Optional[StrictStr] = Field(default=None, description="The Client Order ID (cloid) to identify the order to cancel.")
    __properties: ClassVar[List[str]] = ["asset", "cloid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CancelOrderByCloidRequestActionCancelsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CancelOrderByCloidRequestActionCancelsInner from a dict"""
        if obj is None:
            return None
