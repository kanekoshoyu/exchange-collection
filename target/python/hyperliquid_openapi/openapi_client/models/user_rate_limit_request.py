...
class UserRateLimitRequest(BaseModel):
    ...
    type: StrictStr = Field(description="Request type to check user rate limits.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserRateLimitRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserRateLimitRequest from a dict"""
        if obj is None:
            return None
