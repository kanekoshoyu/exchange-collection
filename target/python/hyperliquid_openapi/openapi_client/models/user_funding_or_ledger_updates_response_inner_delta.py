...
class UserFundingOrLedgerUpdatesResponseInnerDelta(BaseModel):
    """
    Details of the change in the user's balance.
    """ # noqa: E501
    coin: Optional[StrictStr] = Field(default=None, description="The cryptocurrency or asset symbol.")
    funding_rate: Optional[StrictStr] = Field(default=None, description="The rate of funding applicable.", alias="fundingRate")
    szi: Optional[StrictStr] = Field(default=None, description="The size of the position affected.")
    type: Optional[StrictStr] = Field(default=None, description="The type of ledger update, e.g., funding or non-funding.")
    usdc: Optional[StrictStr] = Field(default=None, description="The change in USDC balance.")
    __properties: ClassVar[List[str]] = ["coin", "fundingRate", "szi", "type", "usdc"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserFundingOrLedgerUpdatesResponseInnerDelta from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserFundingOrLedgerUpdatesResponseInnerDelta from a dict"""
        if obj is None:
            return None
