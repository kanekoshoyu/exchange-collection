...
class OrderSignedRequestRequestPayloadAction(BaseModel):
    """
    OrderSignedRequestRequestPayloadAction
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="The type of action to perform.")
    orders: Optional[List[OrderSignedRequestRequestPayloadActionOrdersInner]] = Field(default=None, description="List of orders to execute.")
    grouping: Optional[StrictStr] = Field(default=None, description="Grouping type for the order.")
    __properties: ClassVar[List[str]] = ["type", "orders", "grouping"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderSignedRequestRequestPayloadAction from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderSignedRequestRequestPayloadAction from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "orders": [OrderSignedRequestRequestPayloadActionOrdersInner.from_dict(_item) for _item in obj["orders"]] if obj.get("orders") is not None else None,
