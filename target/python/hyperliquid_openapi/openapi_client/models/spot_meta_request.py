...
class SpotMetaRequest(BaseModel):
    """
    ### Request Schema This request schema is used to retrieve spot metadata. 
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="The type of request. Use \"spotMeta\" to retrieve spot metadata. ")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['spotMeta']):
            raise ValueError("must be one of enum values ('spotMeta')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SpotMetaRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SpotMetaRequest from a dict"""
        if obj is None:
            return None
