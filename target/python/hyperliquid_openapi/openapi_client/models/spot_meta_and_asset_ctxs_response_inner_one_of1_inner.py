...
class SpotMetaAndAssetCtxsResponseInnerOneOf1Inner(BaseModel):
    """
    SpotMetaAndAssetCtxsResponseInnerOneOf1Inner
    """ # noqa: E501
    day_ntl_vlm: Optional[StrictStr] = Field(default=None, alias="dayNtlVlm")
    mark_px: Optional[StrictStr] = Field(default=None, alias="markPx")
    mid_px: Optional[StrictStr] = Field(default=None, alias="midPx")
    prev_day_px: Optional[StrictStr] = Field(default=None, alias="prevDayPx")
    __properties: ClassVar[List[str]] = ["dayNtlVlm", "markPx", "midPx", "prevDayPx"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SpotMetaAndAssetCtxsResponseInnerOneOf1Inner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SpotMetaAndAssetCtxsResponseInnerOneOf1Inner from a dict"""
        if obj is None:
            return None
