...
class UserFundingOrLedgerUpdatesResponseInner(BaseModel):
    """
    UserFundingOrLedgerUpdatesResponseInner
    """ # noqa: E501
    delta: Optional[UserFundingOrLedgerUpdatesResponseInnerDelta] = None
    hash: Optional[StrictStr] = Field(default=None, description="The transaction hash.")
    time: Optional[StrictInt] = Field(default=None, description="The timestamp of the update.")
    __properties: ClassVar[List[str]] = ["delta", "hash", "time"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserFundingOrLedgerUpdatesResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserFundingOrLedgerUpdatesResponseInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "delta": UserFundingOrLedgerUpdatesResponseInnerDelta.from_dict(obj["delta"]) if obj.get("delta") is not None else None,
            "hash": obj.get("hash"),
            "time": obj.get("time")
        })
        return _obj
