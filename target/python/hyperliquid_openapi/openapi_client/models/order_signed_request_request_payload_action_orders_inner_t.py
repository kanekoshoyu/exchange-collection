...
class OrderSignedRequestRequestPayloadActionOrdersInnerT(BaseModel):
    """
    OrderSignedRequestRequestPayloadActionOrdersInnerT
    """ # noqa: E501
    limit: Optional[OrderSignedRequestRequestPayloadActionOrdersInnerTLimit] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderSignedRequestRequestPayloadActionOrdersInnerT from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderSignedRequestRequestPayloadActionOrdersInnerT from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "limit": OrderSignedRequestRequestPayloadActionOrdersInnerTLimit.from_dict(obj["limit"]) if obj.get("limit") is not None else None
        })
        return _obj
