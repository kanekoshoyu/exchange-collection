...
class WebSocketResponseData(BaseModel):
    ...
    """ # noqa: E501
    method: Optional[StrictStr] = Field(default=None, description="The method being invoked (e.g., \"subscribe\").")
    subscription: Optional[WebSocketMessageSubscription] = None
    __properties: ClassVar[List[str]] = ["method", "subscription"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebSocketResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebSocketResponseData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "subscription": WebSocketMessageSubscription.from_dict(obj["subscription"]) if obj.get("subscription") is not None else None
        })
        return _obj
