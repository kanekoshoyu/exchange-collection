...
class SpotMetaResponseUniverseInner(BaseModel):
    """
    SpotMetaResponseUniverseInner
    """ # noqa: E501
    name: Optional[StrictStr] = None
    tokens: Optional[List[StrictInt]] = None
    index: Optional[StrictInt] = None
    is_canonical: Optional[StrictBool] = Field(default=None, alias="isCanonical")
    __properties: ClassVar[List[str]] = ["name", "tokens", "index", "isCanonical"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SpotMetaResponseUniverseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SpotMetaResponseUniverseInner from a dict"""
        if obj is None:
            return None
