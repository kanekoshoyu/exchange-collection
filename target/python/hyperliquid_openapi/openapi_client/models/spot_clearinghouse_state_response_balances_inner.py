...
class SpotClearinghouseStateResponseBalancesInner(BaseModel):
    """
    SpotClearinghouseStateResponseBalancesInner
    """ # noqa: E501
    coin: Optional[StrictStr] = Field(default=None, description="The name of the token (e.g., USDC, PURR).")
    token: Optional[StrictInt] = Field(default=None, description="The index of the token.")
    hold: Optional[StrictStr] = Field(default=None, description="The amount of the token that is on hold.")
    total: Optional[StrictStr] = Field(default=None, description="The total balance of the token.")
    entry_ntl: Optional[StrictStr] = Field(default=None, description="The notional value at entry for the token.", alias="entryNtl")
    __properties: ClassVar[List[str]] = ["coin", "token", "hold", "total", "entryNtl"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SpotClearinghouseStateResponseBalancesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SpotClearinghouseStateResponseBalancesInner from a dict"""
        if obj is None:
            return None
