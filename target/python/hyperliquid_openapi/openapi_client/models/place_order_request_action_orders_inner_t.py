...
class PlaceOrderRequestActionOrdersInnerT(BaseModel):
    """
    The type of order.
    """ # noqa: E501
    limit: Optional[PlaceOrderRequestActionOrdersInnerTLimit] = None
    trigger: Optional[PlaceOrderRequestActionOrdersInnerTTrigger] = None
    __properties: ClassVar[List[str]] = ["limit", "trigger"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlaceOrderRequestActionOrdersInnerT from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlaceOrderRequestActionOrdersInnerT from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "limit": PlaceOrderRequestActionOrdersInnerTLimit.from_dict(obj["limit"]) if obj.get("limit") is not None else None,
            "trigger": PlaceOrderRequestActionOrdersInnerTTrigger.from_dict(obj["trigger"]) if obj.get("trigger") is not None else None
        })
        return _obj
