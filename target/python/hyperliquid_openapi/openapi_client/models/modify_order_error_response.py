...
class ModifyOrderErrorResponse(BaseModel):
    """
    ### Error Response Schema The response body for an error encountered during the modify order request. 
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="Status indicating an error occurred.")
    response: Optional[ModifyOrderErrorResponseResponse] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModifyOrderErrorResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModifyOrderErrorResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "response": ModifyOrderErrorResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
