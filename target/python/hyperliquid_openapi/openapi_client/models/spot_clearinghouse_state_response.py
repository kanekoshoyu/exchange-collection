...
class SpotClearinghouseStateResponse(BaseModel):
    """
    ### Response Schema This schema defines the structure of the response that contains the user's token balances. 
    """ # noqa: E501
    balances: Optional[List[SpotClearinghouseStateResponseBalancesInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SpotClearinghouseStateResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SpotClearinghouseStateResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "balances": [SpotClearinghouseStateResponseBalancesInner.from_dict(_item) for _item in obj["balances"]] if obj.get("balances") is not None else None
        })
        return _obj
