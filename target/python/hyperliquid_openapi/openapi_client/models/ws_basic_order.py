...
class WsBasicOrder(BaseModel):
    """
    WsBasicOrder
    """ # noqa: E501
    coin: Optional[StrictStr] = None
    side: Optional[StrictStr] = None
    limit_px: Optional[StrictStr] = Field(default=None, alias="limitPx")
    ...
    orig_sz: Optional[StrictStr] = Field(default=None, alias="origSz")
    cloid: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["coin", "side", "limitPx", "sz", "oid", "timestamp", "origSz", "cloid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WsBasicOrder from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if cloid (nullable) is None
        # and model_fields_set contains the field
        if self.cloid is None and "cloid" in self.model_fields_set:
            _dict['cloid'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WsBasicOrder from a dict"""
        if obj is None:
            return None
