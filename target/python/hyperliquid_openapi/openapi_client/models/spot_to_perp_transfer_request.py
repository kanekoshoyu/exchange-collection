...
class SpotToPerpTransferRequest(BaseModel):
    """
    ### Request Schema The request body for transferring USDC between the spot wallet and the perpetual wallet. The transfer can be from spot to perp or vice versa. 
    """ # noqa: E501
    action: SpotToPerpTransferRequestAction
    nonce: StrictInt = Field(description="Recommended to use the current timestamp in milliseconds, must match the nonce in the action object.")
    signature: Dict[str, Any] = Field(description="Signature of the request.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SpotToPerpTransferRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SpotToPerpTransferRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "action": SpotToPerpTransferRequestAction.from_dict(obj["action"]) if obj.get("action") is not None else None,
            "nonce": obj.get("nonce"),
