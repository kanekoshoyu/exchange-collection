...
class PlaceOrderRequest(BaseModel):
    """
    ### Request Schema The request body for placing an order. You can specify various order types, conditions, and settings. 
    """ # noqa: E501
    action: PlaceOrderRequestAction
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "action": PlaceOrderRequestAction.from_dict(obj["action"]) if obj.get("action") is not None else None,
            "nonce": obj.get("nonce"),
