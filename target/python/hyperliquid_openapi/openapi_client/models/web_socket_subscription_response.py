...
class WebSocketSubscriptionResponse(BaseModel):
    ...
    """ # noqa: E501
    channel: Optional[StrictStr] = Field(default=None, description="The channel to which the response corresponds.")
    data: Optional[WebSocketSubscriptionResponseData] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebSocketSubscriptionResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebSocketSubscriptionResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": WebSocketSubscriptionResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
