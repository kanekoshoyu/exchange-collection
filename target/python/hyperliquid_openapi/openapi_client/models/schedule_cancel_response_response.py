...
class ScheduleCancelResponseResponse(BaseModel):
    """
    ScheduleCancelResponseResponse
    """ # noqa: E501
    type: Optional[StrictStr] = None
    data: Optional[ScheduleCancelResponseResponseData] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ScheduleCancelResponseResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ScheduleCancelResponseResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "data": ScheduleCancelResponseResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
