...
class MarketDataResponse(BaseModel):
    ...
    MarketDataResponse
    """ # noqa: E501
    ape: Optional[StrictStr] = Field(default=None, description="APE market data value.", alias="APE")
    arb: Optional[StrictStr] = Field(default=None, description="ARB market data value.", alias="ARB")
    __properties: ClassVar[List[str]] = ["APE", "ARB"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MarketDataResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MarketDataResponse from a dict"""
        if obj is None:
            return None
