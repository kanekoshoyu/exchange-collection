...
class PlaceOrderRequestActionOrdersInnerTLimit(BaseModel):
    """
    Limit order details.
    """ # noqa: E501
    tif: Optional[StrictStr] = Field(default=None, description="Time-in-force for limit orders: - **ALO**: Add liquidity only (post only) - **IOC**: Immediate or cancel - **GTC**: Good til canceled ")
    __properties: ClassVar[List[str]] = ["tif"]
    ...
    def tif_validate_enum(cls, value):
        ...
        if value not in set(['Alo', 'Ioc', 'Gtc']):
            raise ValueError("must be one of enum values ('Alo', 'Ioc', 'Gtc')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlaceOrderRequestActionOrdersInnerTLimit from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlaceOrderRequestActionOrdersInnerTLimit from a dict"""
        if obj is None:
            return None
