...
class OrderSignedRequest(BaseModel):
    """
    OrderSignedRequest
    """ # noqa: E501
    method: Optional[StrictStr] = Field(default=None, description="The method of the request.")
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the request.")
    request: Optional[OrderSignedRequestRequest] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderSignedRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderSignedRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "request": OrderSignedRequestRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
