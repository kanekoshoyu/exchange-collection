...
class SpotMetaResponseTokensInner(BaseModel):
    """
    SpotMetaResponseTokensInner
    """ # noqa: E501
    name: Optional[StrictStr] = None
    sz_decimals: Optional[StrictInt] = Field(default=None, alias="szDecimals")
    wei_decimals: Optional[StrictInt] = Field(default=None, alias="weiDecimals")
    index: Optional[StrictInt] = None
    token_id: Optional[StrictStr] = Field(default=None, alias="tokenId")
    is_canonical: Optional[StrictBool] = Field(default=None, alias="isCanonical")
    evm_contract: Optional[StrictStr] = Field(default=None, alias="evmContract")
    full_name: Optional[StrictStr] = Field(default=None, alias="fullName")
    __properties: ClassVar[List[str]] = ["name", "szDecimals", "weiDecimals", "index", "tokenId", "isCanonical", "evmContract", "fullName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SpotMetaResponseTokensInner from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if evm_contract (nullable) is None
        # and model_fields_set contains the field
        if self.evm_contract is None and "evm_contract" in self.model_fields_set:
            _dict['evmContract'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SpotMetaResponseTokensInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "szDecimals": obj.get("szDecimals"),
            "weiDecimals": obj.get("weiDecimals"),
            "index": obj.get("index"),
            "tokenId": obj.get("tokenId"),
            "isCanonical": obj.get("isCanonical"),
            "evmContract": obj.get("evmContract"),
