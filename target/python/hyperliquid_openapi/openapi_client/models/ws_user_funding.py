...
class WsUserFunding(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["time", "coin", "usdc", "szi", "fundingRate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WsUserFunding from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WsUserFunding from a dict"""
        if obj is None:
            return None
