...
class FundingHistoryResponseInner(BaseModel):
    """
    FundingHistoryResponseInner
    """ # noqa: E501
    coin: Optional[StrictStr] = Field(default=None, description="The cryptocurrency or asset symbol.")
    funding_rate: Optional[StrictStr] = Field(default=None, description="The rate of funding applicable at the time.", alias="fundingRate")
    premium: Optional[StrictStr] = Field(default=None, description="The premium associated with the funding.")
    time: Optional[StrictInt] = Field(default=None, description="The timestamp of the funding rate update.")
    __properties: ClassVar[List[str]] = ["coin", "fundingRate", "premium", "time"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FundingHistoryResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FundingHistoryResponseInner from a dict"""
        if obj is None:
            return None
