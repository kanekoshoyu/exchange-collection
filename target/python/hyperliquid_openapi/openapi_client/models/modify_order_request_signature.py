...
class ModifyOrderRequestSignature(BaseModel):
    """
    ModifyOrderRequestSignature
    """ # noqa: E501
    vault_address: Optional[StrictStr] = Field(default=None, description="If trading on behalf of a vault, its Onchain address in 42-character hexadecimal format. Example: 0x0000000000000000000000000000000000000000 ", alias="vaultAddress")
    __properties: ClassVar[List[str]] = ["vaultAddress"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModifyOrderRequestSignature from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModifyOrderRequestSignature from a dict"""
        if obj is None:
            return None
