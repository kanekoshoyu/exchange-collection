...
class PlaceOrderRestingResponseResponseDataStatusesInner(BaseModel):
    """
    PlaceOrderRestingResponseResponseDataStatusesInner
    """ # noqa: E501
    resting: Optional[PlaceOrderRestingResponseResponseDataStatusesInnerResting] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlaceOrderRestingResponseResponseDataStatusesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlaceOrderRestingResponseResponseDataStatusesInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "resting": PlaceOrderRestingResponseResponseDataStatusesInnerResting.from_dict(obj["resting"]) if obj.get("resting") is not None else None
        })
        return _obj
