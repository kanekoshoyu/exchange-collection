...
class WsUserNonFundingLedgerUpdate(BaseModel):
    """
    WsUserNonFundingLedgerUpdate
    """ # noqa: E501
    time: Optional[Union[StrictFloat, StrictInt]] = None
    coin: Optional[StrictStr] = None
    usdc: Optional[StrictStr] = None
    szi: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["time", "coin", "usdc", "szi"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WsUserNonFundingLedgerUpdate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WsUserNonFundingLedgerUpdate from a dict"""
        if obj is None:
            return None
