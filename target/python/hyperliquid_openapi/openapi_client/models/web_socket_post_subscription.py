...
class WebSocketPostSubscription(BaseModel):
    """
    WebSocketPostSubscription
    """ # noqa: E501
    method: Optional[StrictStr] = Field(default=None, description="The HTTP method used.")
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the request.")
    request: Optional[WebSocketPostSubscriptionRequest] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebSocketPostSubscription from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebSocketPostSubscription from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "request": WebSocketPostSubscriptionRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
