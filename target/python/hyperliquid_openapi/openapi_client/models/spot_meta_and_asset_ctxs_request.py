...
class SpotMetaAndAssetCtxsRequest(BaseModel):
    """
    ### Request Schema This request schema is used to retrieve spot asset contexts. 
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="The type of request. Use \"spotMetaAndAssetCtxs\" to retrieve spot asset contexts. ")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SpotMetaAndAssetCtxsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SpotMetaAndAssetCtxsRequest from a dict"""
        if obj is None:
            return None
