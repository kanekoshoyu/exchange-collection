...
class CancelOrderRequestActionCancelsInner(BaseModel):
    """
    CancelOrderRequestActionCancelsInner
    """ # noqa: E501
    a: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The asset.")
    o: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The order ID (oid).")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CancelOrderRequestActionCancelsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CancelOrderRequestActionCancelsInner from a dict"""
        if obj is None:
            return None
