...
class WebSocketPostResponseData(BaseModel):
    """
    WebSocketPostResponseData
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the response.")
    response: Optional[WebSocketPostResponseDataResponse] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebSocketPostResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebSocketPostResponseData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "response": WebSocketPostResponseDataResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
