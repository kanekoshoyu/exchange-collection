...
class CandleSnapshotResponseInnerInner(BaseModel):
    """
    CandleSnapshotResponseInnerInner
    """ # noqa: E501
    t: Optional[StrictInt] = Field(default=None, description="The end time of the candle in epoch milliseconds.", alias="T")
    c: Optional[StrictStr] = Field(default=None, description="The closing price of the candle.")
    h: Optional[StrictStr] = Field(default=None, description="The highest price during the candle interval.")
    i: Optional[StrictStr] = Field(default=None, description="The interval for the candle.")
    l: Optional[StrictStr] = Field(default=None, description="The lowest price during the candle interval.")
    n: Optional[StrictInt] = Field(default=None, description="The number of trades during the candle interval.")
    o: Optional[StrictStr] = Field(default=None, description="The opening price of the candle.")
    s: Optional[StrictStr] = Field(default=None, description="The cryptocurrency coin symbol.")
    t: Optional[StrictInt] = Field(default=None, description="The start time of the candle in epoch milliseconds.")
    v: Optional[StrictStr] = Field(default=None, description="The volume of trades during the candle interval.")
    __properties: ClassVar[List[str]] = ["T", "c", "h", "i", "l", "n", "o", "s", "t", "v"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CandleSnapshotResponseInnerInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CandleSnapshotResponseInnerInner from a dict"""
        if obj is None:
            return None
