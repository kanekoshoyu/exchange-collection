...
class SpotMetaResponse(BaseModel):
    """
    ### Response Schema This response schema contains spot metadata, including token details and trading pairs. 
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SpotMetaResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SpotMetaResponse from a dict"""
        if obj is None:
            return None
