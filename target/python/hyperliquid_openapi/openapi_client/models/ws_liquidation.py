...
class WsLiquidation(BaseModel):
    ...
    WsLiquidation
    """ # noqa: E501
    lid: Optional[Union[StrictFloat, StrictInt]] = None
    liquidator: Optional[StrictStr] = None
    liquidated_user: Optional[StrictStr] = None
    liquidated_ntl_pos: Optional[StrictStr] = None
    liquidated_account_value: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["lid", "liquidator", "liquidated_user", "liquidated_ntl_pos", "liquidated_account_value"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WsLiquidation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WsLiquidation from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "liquidated_user": obj.get("liquidated_user"),
            "liquidated_ntl_pos": obj.get("liquidated_ntl_pos"),
            "liquidated_account_value": obj.get("liquidated_account_value")
        })
        return _obj
