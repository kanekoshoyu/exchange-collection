...
class CancelOrderByCloidRequest(BaseModel):
    """
    ### Request Schema The request body for canceling orders by Client Order ID (cloid). You can specify one or more orders to cancel using their cloID and the associated asset. 
    """ # noqa: E501
    action: CancelOrderByCloidRequestAction
    nonce: Union[StrictFloat, StrictInt] = Field(description="Recommended to use the current timestamp in milliseconds.")
    signature: Dict[str, Any] = Field(description="Contains signature details.")
    vault_address: Optional[StrictStr] = Field(default=None, description="Onchain address in 42-character hexadecimal format, required if trading on behalf of a vault. Example: 0x0000000000000000000000000000000000000000. ", alias="vaultAddress")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CancelOrderByCloidRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CancelOrderByCloidRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "action": CancelOrderByCloidRequestAction.from_dict(obj["action"]) if obj.get("action") is not None else None,
            "nonce": obj.get("nonce"),
