...
class OrderStatusResponse(BaseModel):
    ...
    status: Optional[StrictStr] = Field(default=None, description="The current status of the order.")
    timestamp: Optional[StrictInt] = Field(default=None, description="The timestamp when the status was last updated.")
    __properties: ClassVar[List[str]] = ["orderId", "status", "timestamp"]
