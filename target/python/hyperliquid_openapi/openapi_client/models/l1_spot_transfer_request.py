...
class L1SpotTransferRequest(BaseModel):
    """
    ### Request Schema The request body for sending spot assets to another address without touching the EVM bridge. 
    """ # noqa: E501
    action: L1SpotTransferRequestAction
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of L1SpotTransferRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of L1SpotTransferRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "action": L1SpotTransferRequestAction.from_dict(obj["action"]) if obj.get("action") is not None else None,
            "nonce": obj.get("nonce"),
