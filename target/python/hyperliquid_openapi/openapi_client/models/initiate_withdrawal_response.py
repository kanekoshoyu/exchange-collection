...
class InitiateWithdrawalResponse(BaseModel):
    """
    ### Successful Response Schema The response body indicating the status of the withdrawal request. 
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="Status of the withdrawal request.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InitiateWithdrawalResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InitiateWithdrawalResponse from a dict"""
        if obj is None:
            return None
