...
class SpotToPerpTransferRequestAction(BaseModel):
    """
    SpotToPerpTransferRequestAction
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Must be \"spotUser\".")
    class_transfer: SpotToPerpTransferRequestActionClassTransfer = Field(alias="classTransfer")
    __properties: ClassVar[List[str]] = ["type", "classTransfer"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SpotToPerpTransferRequestAction from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of class_transfer
        if self.class_transfer:
            _dict['classTransfer'] = self.class_transfer.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SpotToPerpTransferRequestAction from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "classTransfer": SpotToPerpTransferRequestActionClassTransfer.from_dict(obj["classTransfer"]) if obj.get("classTransfer") is not None else None
        })
        return _obj
