...
class SpotToPerpTransferErrorResponse(BaseModel):
    """
    ### Error Response Schema The response body for an error encountered during the transfer request. 
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="Status indicating an error occurred.")
    response: Optional[SpotToPerpTransferErrorResponseResponse] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SpotToPerpTransferErrorResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SpotToPerpTransferErrorResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "response": SpotToPerpTransferErrorResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
