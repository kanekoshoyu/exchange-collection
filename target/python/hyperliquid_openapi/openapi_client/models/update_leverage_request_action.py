...
class UpdateLeverageRequestAction(BaseModel):
    """
    UpdateLeverageRequestAction
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Must be \"updateLeverage\".")
    asset: Optional[StrictInt] = Field(default=None, description="Index of the coin for which leverage is being updated.")
    is_cross: Optional[StrictBool] = Field(default=None, description="Whether to update cross-leverage. Set to `true` for cross, `false` for isolated.", alias="isCross")
    leverage: Optional[StrictInt] = Field(default=None, description="New leverage value, subject to leverage constraints on that coin.")
    __properties: ClassVar[List[str]] = ["type", "asset", "isCross", "leverage"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateLeverageRequestAction from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateLeverageRequestAction from a dict"""
        if obj is None:
            return None
