...
class OrderStatusRequest(BaseModel):
    ...
    type: StrictStr = Field(description="Request type to query order status.")
    oid: StrictStr = Field(description="Either a u64 representing the order id or a 16-byte hex string representing the client order id.")
    __properties: ClassVar[List[str]] = ["user", "type", "oid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderStatusRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderStatusRequest from a dict"""
        if obj is None:
            return None
