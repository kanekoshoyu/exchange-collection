...
class VaultTransferRequestAction(BaseModel):
    """
    VaultTransferRequestAction
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Must be \"vaultTransfer\".")
    vault_address: StrictStr = Field(description="Address of the vault in 42-character hexadecimal format.", alias="vaultAddress")
    is_deposit: StrictBool = Field(description="If true, the request is for depositing funds into the vault. If false, the request is for withdrawing funds from the vault.", alias="isDeposit")
    usd: Union[StrictFloat, StrictInt] = Field(description="Amount of USD to deposit or withdraw.")
    __properties: ClassVar[List[str]] = ["type", "vaultAddress", "isDeposit", "usd"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VaultTransferRequestAction from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VaultTransferRequestAction from a dict"""
        if obj is None:
            return None
