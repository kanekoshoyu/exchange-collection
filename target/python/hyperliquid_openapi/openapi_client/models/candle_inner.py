...
class CandleInner(BaseModel):
    """
    CandleInner
    """ # noqa: E501
    t: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Open time in milliseconds")
    t: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Close time in milliseconds", alias="T")
    s: Optional[StrictStr] = Field(default=None, description="Coin symbol")
    ...
    v: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Volume (base unit)")
    n: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Number of trades")
    __properties: ClassVar[List[str]] = ["t", "T", "s", "i", "o", "c", "h", "l", "v", "n"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CandleInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CandleInner from a dict"""
        if obj is None:
            return None
