...
class UserFillsResponseInner(BaseModel):
    """
    UserFillsResponseInner
    """ # noqa: E501
    closed_pnl: Optional[StrictStr] = Field(default=None, description="The closed PnL for the fill.", alias="closedPnl")
    coin: Optional[StrictStr] = Field(default=None, description="The cryptocurrency coin involved in the fill.")
    crossed: Optional[StrictBool] = Field(default=None, description="Whether the order was crossed.")
    dir: Optional[StrictStr] = Field(default=None, description="The direction of the order (e.g., Open Long).")
    hash: Optional[StrictStr] = Field(default=None, description="The transaction hash.")
    oid: Optional[StrictInt] = Field(default=None, description="The order ID.")
    px: Optional[StrictStr] = Field(default=None, description="The price at which the fill occurred.")
    side: Optional[StrictStr] = Field(default=None, description="The side of the order (e.g., Buy or Sell).")
    start_position: Optional[StrictStr] = Field(default=None, description="The starting position of the order.", alias="startPosition")
    sz: Optional[StrictStr] = Field(default=None, description="The size of the fill.")
    time: Optional[StrictInt] = Field(default=None, description="The timestamp of the fill.")
    __properties: ClassVar[List[str]] = ["closedPnl", "coin", "crossed", "dir", "hash", "oid", "px", "side", "startPosition", "sz", "time"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserFillsResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserFillsResponseInner from a dict"""
        if obj is None:
            return None
