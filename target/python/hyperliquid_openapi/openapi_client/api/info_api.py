...
class InfoApi:
    ...
    @validate_call
    def get_info_or_orders(
        self,
        get_info_or_orders_request: GetInfoOrOrdersRequest,
        ...
        """Fetch Information about exchange and users
        ...
        :param get_info_or_orders_request: (required)
        :type get_info_or_orders_request: GetInfoOrOrdersRequest
        ...
        _param = self._get_info_or_orders_serialize(
            get_info_or_orders_request=get_info_or_orders_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetInfoOrOrders200Response",
            '400': "Error",
            '402': "Error",
            '404': "Error",
            '422': "Error",
    ...
    @validate_call
    def get_info_or_orders_with_http_info(
        self,
        get_info_or_orders_request: GetInfoOrOrdersRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetInfoOrOrders200Response]:
        """Fetch Information about exchange and users
    ...
    @validate_call
    def get_info_or_orders_without_preload_content(
        self,
        get_info_or_orders_request: GetInfoOrOrdersRequest,
        _request_timeout: Union[
            None,
    ...
    def _get_info_or_orders_serialize(
        self,
        get_info_or_orders_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if get_info_or_orders_request is not None:
            _body_params = get_info_or_orders_request
