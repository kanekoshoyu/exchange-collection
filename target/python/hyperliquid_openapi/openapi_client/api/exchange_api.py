...
class ExchangeApi:
    ...
    def exchange_post(
        self,
        exchange_post_request: ExchangePostRequest,
        ...
        :param exchange_post_request: (required)
        :type exchange_post_request: ExchangePostRequest
        ...
        _param = self._exchange_post_serialize(
            exchange_post_request=exchange_post_request,
    ...
    @validate_call
    def exchange_post_with_http_info(
        self,
        exchange_post_request: ExchangePostRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ExchangePost200Response]:
        """Place an order
    ...
    @validate_call
    def exchange_post_without_preload_content(
        self,
        exchange_post_request: ExchangePostRequest,
        _request_timeout: Union[
            None,
    ...
    def _exchange_post_serialize(
        self,
        exchange_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if exchange_post_request is not None:
            _body_params = exchange_post_request
