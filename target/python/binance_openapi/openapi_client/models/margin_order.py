...
class MarginOrder(BaseModel):
    ...
    type: StrictStr
    side: StrictStr
    __properties: ClassVar[List[str]] = ["symbol", "orderId", "origClientOrderId", "clientOrderId", "price", "origQty", "executedQty", "cummulativeQuoteQty", "status", "timeInForce", "type", "side"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MarginOrder from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MarginOrder from a dict"""
        if obj is None:
            return None
