...
class SapiV2LoanFlexibleRepayHistoryGet200ResponseRowsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["loanCoin", "repayAmount", "collateralCoin", "collateralReturn", "repayStatus", "repayTime"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SapiV2LoanFlexibleRepayHistoryGet200ResponseRowsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SapiV2LoanFlexibleRepayHistoryGet200ResponseRowsInner from a dict"""
        if obj is None:
            return None
