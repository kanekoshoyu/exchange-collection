...
class CanceledMarginOrderDetail(BaseModel):
    ...
    type: StrictStr
    side: StrictStr
    __properties: ClassVar[List[str]] = ["symbol", "isIsolated", "origClientOrderId", "orderId", "orderListId", "clientOrderId", "price", "origQty", "executedQty", "cummulativeQuoteQty", "status", "timeInForce", "type", "side"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CanceledMarginOrderDetail from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CanceledMarginOrderDetail from a dict"""
        if obj is None:
            return None
