...
class SapiV1AlgoSpotSubOrdersGet200ResponseSubOrdersInner(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SapiV1AlgoSpotSubOrdersGet200ResponseSubOrdersInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SapiV1AlgoSpotSubOrdersGet200ResponseSubOrdersInner from a dict"""
        if obj is None:
            return None
