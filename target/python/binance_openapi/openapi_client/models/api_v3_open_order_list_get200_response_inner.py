...
class ApiV3OpenOrderListGet200ResponseInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["orderListId", "contingencyType", "listStatusType", "listOrderStatus", "listClientOrderId", "transactionTime", "symbol", "orders"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiV3OpenOrderListGet200ResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiV3OpenOrderListGet200ResponseInner from a dict"""
        if obj is None:
            return None
