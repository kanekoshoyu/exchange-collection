...
class SapiV1SubAccountFuturesAccountSummaryGet200Response(BaseModel):
    """
    ...
    asset: StrictStr
    sub_account_list: List[SapiV1SubAccountFuturesAccountSummaryGet200ResponseSubAccountListInner] = Field(alias="subAccountList")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SapiV1SubAccountFuturesAccountSummaryGet200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SapiV1SubAccountFuturesAccountSummaryGet200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "asset": obj.get("asset"),
            "subAccountList": [SapiV1SubAccountFuturesAccountSummaryGet200ResponseSubAccountListInner.from_dict(_item) for _item in obj["subAccountList"]] if obj.get("subAccountList") is not None else None
        })
        return _obj
