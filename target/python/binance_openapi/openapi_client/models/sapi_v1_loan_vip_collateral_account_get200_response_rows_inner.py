...
class SapiV1LoanVipCollateralAccountGet200ResponseRowsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["collateralAccountId", "collateralCoin", "collateralValue"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SapiV1LoanVipCollateralAccountGet200ResponseRowsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SapiV1LoanVipCollateralAccountGet200ResponseRowsInner from a dict"""
        if obj is None:
            return None
