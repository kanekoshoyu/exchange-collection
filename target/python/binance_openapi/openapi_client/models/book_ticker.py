...
class BookTicker(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["symbol", "bidPrice", "bidQty", "askPrice", "askQty"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BookTicker from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BookTicker from a dict"""
        if obj is None:
            return None
