...
class ApiV3AllOrderListGet200ResponseInner(BaseModel):
    """
    ...
    orders: List[ApiV3AllOrderListGet200ResponseInnerOrdersInner]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiV3AllOrderListGet200ResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiV3AllOrderListGet200ResponseInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "orders": [ApiV3AllOrderListGet200ResponseInnerOrdersInner.from_dict(_item) for _item in obj["orders"]] if obj.get("orders") is not None else None
        })
        return _obj
