...
class SapiV1LoanOngoingOrdersGet200ResponseRowsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["orderId", "loanCoin", "totalDebt", "residualInterest", "collateralCoin", "collateralAmount", "currentLTV", "expirationTime"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SapiV1LoanOngoingOrdersGet200ResponseRowsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SapiV1LoanOngoingOrdersGet200ResponseRowsInner from a dict"""
        if obj is None:
            return None
