...
class OcoOrder(BaseModel):
    ...
    order_reports: List[OcoOrderOrderReportsInner] = Field(alias="orderReports")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OcoOrder from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OcoOrder from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "orderReports": [OcoOrderOrderReportsInner.from_dict(_item) for _item in obj["orderReports"]] if obj.get("orderReports") is not None else None
        })
        return _obj
