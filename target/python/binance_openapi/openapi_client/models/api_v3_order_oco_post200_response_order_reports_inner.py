...
class ApiV3OrderOcoPost200ResponseOrderReportsInner(BaseModel):
    """
    ApiV3OrderOcoPost200ResponseOrderReportsInner
    """ # noqa: E501
    symbol: StrictStr
    ...
    working_time: StrictStr = Field(alias="workingTime")
    self_trade_prevention_mode: StrictStr = Field(alias="selfTradePreventionMode")
    __properties: ClassVar[List[str]] = ["symbol", "orderId", "orderListId", "clientOrderId", "transactTime", "price", "origQty", "executedQty", "cummulativeQuoteQty", "status", "timeInForce", "type", "side", "stopPrice", "workingTime", "selfTradePreventionMode"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiV3OrderOcoPost200ResponseOrderReportsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiV3OrderOcoPost200ResponseOrderReportsInner from a dict"""
        if obj is None:
            return None
