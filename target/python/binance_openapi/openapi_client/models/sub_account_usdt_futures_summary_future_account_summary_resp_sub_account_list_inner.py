...
class SubAccountUSDTFuturesSummaryFutureAccountSummaryRespSubAccountListInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["email", "totalInitialMargin", "totalMaintenanceMargin", "totalMarginBalance", "totalOpenOrderInitialMargin", "totalPositionInitialMargin", "totalUnrealizedProfit", "totalWalletBalance", "asset"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubAccountUSDTFuturesSummaryFutureAccountSummaryRespSubAccountListInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubAccountUSDTFuturesSummaryFutureAccountSummaryRespSubAccountListInner from a dict"""
        if obj is None:
            return None
