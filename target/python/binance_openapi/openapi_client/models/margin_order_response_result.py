...
class MarginOrderResponseResult(BaseModel):
    ...
    side: StrictStr
    __properties: ClassVar[List[str]] = ["symbol", "orderId", "clientOrderId", "transactTime", "price", "origQty", "executedQty", "cummulativeQuoteQty", "status", "timeInForce", "type", "isIsolated", "side"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MarginOrderResponseResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MarginOrderResponseResult from a dict"""
        if obj is None:
            return None
