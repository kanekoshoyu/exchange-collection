...
class DayTicker(BaseModel):
    """
    DayTicker
    """ # noqa: E501
    symbol: StrictStr
    price_change: StrictStr = Field(description="Absolute price change", alias="priceChange")
    price_change_percent: StrictStr = Field(description="Relative price change in percent", alias="priceChangePercent")
    weighted_avg_price: StrictStr = Field(description="quoteVolume / volume", alias="weightedAvgPrice")
    ...
    volume: StrictStr = Field(description="Volume in base asset")
    quote_volume: StrictStr = Field(description="Volume in quote asset", alias="quoteVolume")
    open_time: StrictInt = Field(alias="openTime")
    close_time: StrictInt = Field(alias="closeTime")
    first_id: StrictInt = Field(description="Trade ID of the first trade in the interval", alias="firstId")
    last_id: StrictInt = Field(description="Trade ID of the last trade in the interval", alias="lastId")
    count: StrictInt = Field(description="Number of trades in the interval")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DayTicker from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DayTicker from a dict"""
        if obj is None:
            return None
