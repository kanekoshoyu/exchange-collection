...
class MarginOcoOrderOrderReportsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["symbol", "origClientOrderId", "orderId", "orderListId", "clientOrderId", "price", "origQty", "executedQty", "cummulativeQuoteQty", "status", "timeInForce", "type", "side", "stopPrice"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MarginOcoOrderOrderReportsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MarginOcoOrderOrderReportsInner from a dict"""
        if obj is None:
            return None
