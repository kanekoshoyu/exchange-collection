...
class Order(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["symbol", "origClientOrderId", "orderId", "orderListId", "clientOrderId", "transactTime", "price", "origQty", "executedQty", "cummulativeQuoteQty", "status", "timeInForce", "type", "side", "selfTradePreventionMode"]
