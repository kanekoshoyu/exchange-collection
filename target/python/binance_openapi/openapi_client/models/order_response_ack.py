...
class OrderResponseAck(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["symbol", "orderId", "orderListId", "clientOrderId", "transactTime"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderResponseAck from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderResponseAck from a dict"""
        if obj is None:
            return None
